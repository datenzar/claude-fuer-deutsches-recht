---
name: agb-recht-pruefer-nda-standardbedingungen
...
> Opencode-Port von `agb-recht-pruefer/skills/nda-standardbedingungen/SKILL.md`. Urspruenglicher Skill-Name: `nda-standardbedingungen`.

# NDA Standardbedingungen

## Wann verwenden

Nutze diesen Skill für **NDA Standardbedingungen** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
