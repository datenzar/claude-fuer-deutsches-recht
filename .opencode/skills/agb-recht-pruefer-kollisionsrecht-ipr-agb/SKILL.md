---
name: agb-recht-pruefer-kollisionsrecht-ipr-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/kollisionsrecht-ipr-agb/SKILL.md`. Urspruenglicher Skill-Name: `kollisionsrecht-ipr-agb`.

# Kollisionsrecht IPR AGB

## Wann verwenden

Nutze diesen Skill für **Kollisionsrecht IPR AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
