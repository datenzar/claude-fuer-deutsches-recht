---
name: vertragsrecht-saas-msa-pruefung
...
> Opencode-Port von `vertragsrecht/skills/saas-msa-pruefung/SKILL.md`. Urspruenglicher Skill-Name: `saas-msa-pruefung`.

# SaaS-/MSA-Prüfung

## Zweck

SaaS-Verträge haben ein anderes Risikoprofil als einmalige Lieferantenverträge. Die Kosten akkumulieren über Verlängerungen, die Daten häufen sich an, und die Wechselkosten wachsen monatlich. Dieser Skill prüft unter Berücksichtigung dieser Besonderheiten. Er führt die Standard-Playbook-Prüfung aus `.opencode/profile/vertragsrecht.md` durch und ergänzt sie um einen SaaS-spezifischen Prüfaufschlag für die Punkte, die bei Abonnementverträgen besonders gefährlich sind.
...
Aus `.opencode/profile/vertragsrecht.md` den zutreffenden Playbook-Abschnitt lesen. Falls nicht konfiguriert: Setup-Befehl nennen.
