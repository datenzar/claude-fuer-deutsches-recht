---
name: gewerblicher-rechtsschutz-open-source-pruefung
...
> Opencode-Port von `gewerblicher-rechtsschutz/skills/open-source-pruefung/SKILL.md`. Urspruenglicher Skill-Name: `open-source-pruefung`.
