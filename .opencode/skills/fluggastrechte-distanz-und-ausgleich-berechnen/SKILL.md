---
name: fluggastrechte-distanz-und-ausgleich-berechnen
...
> Opencode-Port von `fluggastrechte/skills/distanz-und-ausgleich-berechnen/SKILL.md`. Urspruenglicher Skill-Name: `distanz-und-ausgleich-berechnen`.
