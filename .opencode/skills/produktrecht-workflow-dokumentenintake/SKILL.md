---
name: produktrecht-workflow-dokumentenintake
...
> Opencode-Port von `produktrecht/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
