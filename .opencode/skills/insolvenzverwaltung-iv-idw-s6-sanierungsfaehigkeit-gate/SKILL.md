---
name: insolvenzverwaltung-iv-idw-s6-sanierungsfaehigkeit-gate
...
> Opencode-Port von `insolvenzverwaltung/skills/iv-idw-s6-sanierungsfaehigkeit-gate/SKILL.md`. Urspruenglicher Skill-Name: `iv-idw-s6-sanierungsfaehigkeit-gate`.
