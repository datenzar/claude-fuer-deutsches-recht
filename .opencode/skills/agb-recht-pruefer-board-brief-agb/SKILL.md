---
name: agb-recht-pruefer-board-brief-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/board-brief-agb/SKILL.md`. Urspruenglicher Skill-Name: `board-brief-agb`.

# Board Brief AGB

## Wann verwenden

Nutze diesen Skill für **Board Brief AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
