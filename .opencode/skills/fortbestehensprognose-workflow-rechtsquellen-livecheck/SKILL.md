---
name: fortbestehensprognose-workflow-rechtsquellen-livecheck
...
> Opencode-Port von `fortbestehensprognose/skills/workflow-rechtsquellen-livecheck/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsquellen-livecheck`.
