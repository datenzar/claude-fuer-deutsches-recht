---
name: arbeitsrecht-agg-pruefung-bewerber-und-beschaeftigte
...
> Opencode-Port von `arbeitsrecht/skills/agg-pruefung-bewerber-und-beschaeftigte/SKILL.md`. Urspruenglicher Skill-Name: `agg-pruefung-bewerber-und-beschaeftigte`.
...
- `.opencode/profile/arbeitsrecht.md` → Einstellungs- und HR-Richtlinien
