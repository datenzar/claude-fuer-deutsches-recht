---
name: commercial-courts-deutschland-issues-list-and-roadmap
...
> Opencode-Port von `commercial-courts-deutschland/skills/issues-list-and-roadmap/SKILL.md`. Urspruenglicher Skill-Name: `issues-list-and-roadmap`.
