---
name: agb-recht-pruefer-konto-kuendigung-sperre
...
> Opencode-Port von `agb-recht-pruefer/skills/konto-kuendigung-sperre/SKILL.md`. Urspruenglicher Skill-Name: `konto-kuendigung-sperre`.

# Konto Kündigung Sperre

## Wann verwenden

Nutze diesen Skill für **Konto Kündigung Sperre** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
