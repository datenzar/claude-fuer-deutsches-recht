---
name: rechtsberatungsstelle-workflow-anschluss-skills-router
...
> Opencode-Port von `rechtsberatungsstelle/skills/workflow-anschluss-skills-router/SKILL.md`. Urspruenglicher Skill-Name: `workflow-anschluss-skills-router`.
