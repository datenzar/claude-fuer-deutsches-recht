---
name: fachanwalt-migrationsrecht-workflow-fachkraefte-start
description: "Fachkräfte-Start: Workflow-Skill für Migrationsrecht; klärt Anerkennung, Qualifikation, BA-Zustimmung, Berufsausübung und Visum; mit Statusmatrix, Fristenrettung, Staatenbezug, Quellencheck und nutzbarem Output."
---

> Opencode-Port von `fachanwalt-migrationsrecht/skills/workflow-fachkraefte-start/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fachkraefte-start`.
