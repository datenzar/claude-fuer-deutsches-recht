---
name: agb-recht-pruefer-dokumentation-handbuch
...
> Opencode-Port von `agb-recht-pruefer/skills/dokumentation-handbuch/SKILL.md`. Urspruenglicher Skill-Name: `dokumentation-handbuch`.

# Dokumentation Handbuch

## Wann verwenden

Nutze diesen Skill für **Dokumentation Handbuch** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
