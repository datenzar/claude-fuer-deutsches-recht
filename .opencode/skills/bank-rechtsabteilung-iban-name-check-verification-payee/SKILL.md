---
name: bank-rechtsabteilung-iban-name-check-verification-payee
...
> Opencode-Port von `bank-rechtsabteilung/skills/iban-name-check-verification-payee/SKILL.md`. Urspruenglicher Skill-Name: `iban-name-check-verification-payee`.
