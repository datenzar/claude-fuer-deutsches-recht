---
name: robotik-recht-workflow-board-und-c-level-briefing
...
> Opencode-Port von `robotik-recht/skills/workflow-board-und-c-level-briefing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-board-und-c-level-briefing`.
