---
name: agb-recht-pruefer-subscription-abonnement
...
> Opencode-Port von `agb-recht-pruefer/skills/subscription-abonnement/SKILL.md`. Urspruenglicher Skill-Name: `subscription-abonnement`.

# Subscription Abonnement

## Wann verwenden

Nutze diesen Skill für **Subscription Abonnement** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
