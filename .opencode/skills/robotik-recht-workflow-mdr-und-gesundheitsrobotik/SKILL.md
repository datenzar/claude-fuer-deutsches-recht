---
name: robotik-recht-workflow-mdr-und-gesundheitsrobotik
...
> Opencode-Port von `robotik-recht/skills/workflow-mdr-und-gesundheitsrobotik/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mdr-und-gesundheitsrobotik`.
