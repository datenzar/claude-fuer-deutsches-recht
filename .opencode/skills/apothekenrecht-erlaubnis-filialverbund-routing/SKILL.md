---
name: apothekenrecht-erlaubnis-filialverbund-routing
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Erlaubnis Filialverbund Routing."
---

> Opencode-Port von `apothekenrecht/skills/erlaubnis-filialverbund-routing/SKILL.md`. Urspruenglicher Skill-Name: `erlaubnis-filialverbund-routing`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Erlaubnis Filialverbund Routing..
