---
name: agb-recht-pruefer-klausel-entwerfen-low-risk
...
> Opencode-Port von `agb-recht-pruefer/skills/klausel-entwerfen-low-risk/SKILL.md`. Urspruenglicher Skill-Name: `klausel-entwerfen-low-risk`.

# Klausel Entwerfen Low Risk

## Wann verwenden

Nutze diesen Skill für **Klausel Entwerfen Low Risk** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
