---
name: agb-recht-pruefer-mediation-escalation
...
> Opencode-Port von `agb-recht-pruefer/skills/mediation-escalation/SKILL.md`. Urspruenglicher Skill-Name: `mediation-escalation`.

# Mediation Escalation

## Wann verwenden

Nutze diesen Skill für **Mediation Escalation** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
