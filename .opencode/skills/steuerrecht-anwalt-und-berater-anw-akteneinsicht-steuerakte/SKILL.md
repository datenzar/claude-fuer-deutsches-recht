---
name: steuerrecht-anwalt-und-berater-anw-akteneinsicht-steuerakte
...
> Opencode-Port von `steuerrecht-anwalt-und-berater/skills/anw-akteneinsicht-steuerakte/SKILL.md`. Urspruenglicher Skill-Name: `anw-akteneinsicht-steuerakte`.
...
- Mandantenakte unter `./steuerrecht-anwalt-und-berater/mandate/<az>/`.
