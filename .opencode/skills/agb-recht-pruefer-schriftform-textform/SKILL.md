---
name: agb-recht-pruefer-schriftform-textform
...
> Opencode-Port von `agb-recht-pruefer/skills/schriftform-textform/SKILL.md`. Urspruenglicher Skill-Name: `schriftform-textform`.

# Schriftform Textform

## Wann verwenden

Nutze diesen Skill für **Schriftform Textform** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
