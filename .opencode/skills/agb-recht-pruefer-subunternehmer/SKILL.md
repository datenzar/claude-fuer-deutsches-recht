---
name: agb-recht-pruefer-subunternehmer
...
> Opencode-Port von `agb-recht-pruefer/skills/subunternehmer/SKILL.md`. Urspruenglicher Skill-Name: `subunternehmer`.

# Subunternehmer

## Wann verwenden

Nutze diesen Skill für **Subunternehmer** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
