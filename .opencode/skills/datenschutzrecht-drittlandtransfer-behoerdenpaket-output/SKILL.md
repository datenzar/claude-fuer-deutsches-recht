---
name: datenschutzrecht-drittlandtransfer-behoerdenpaket-output
...
> Opencode-Port von `datenschutzrecht/skills/drittlandtransfer-behoerdenpaket-output/SKILL.md`. Urspruenglicher Skill-Name: `drittlandtransfer-behoerdenpaket-output`.
