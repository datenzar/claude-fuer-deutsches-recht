---
name: vertragsausfueller-vaf-template-format-und-source
...
> Opencode-Port von `vertragsausfueller/skills/vaf-template-format-und-source/SKILL.md`. Urspruenglicher Skill-Name: `vaf-template-format-und-source`.
