---
name: agb-recht-pruefer-gewerbemiete-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/gewerbemiete-agb/SKILL.md`. Urspruenglicher Skill-Name: `gewerbemiete-agb`.

# Gewerbemiete AGB

## Wann verwenden

Nutze diesen Skill für **Gewerbemiete AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
