---
name: krisenfrueherkennung-starug-workflow-dokumentenintake
...
> Opencode-Port von `krisenfrueherkennung-starug/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
