---
name: vertragsausfueller-workflow-kaltstart-und-routing
...
> Opencode-Port von `vertragsausfueller/skills/workflow-kaltstart-und-routing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-kaltstart-und-routing`.
