---
name: vertragsrecht-vertragsrecht-kaltstart-interview
...
> Opencode-Port von `vertragsrecht/skills/vertragsrecht-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `vertragsrecht-kaltstart-interview`.
...
Lies `.opencode/plugins/config/klotzkette/vertragsrecht/CLAUDE.md`:
