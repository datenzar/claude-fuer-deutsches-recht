---
name: ki-governance-ki-governance-anpassen
...
> Opencode-Port von `ki-governance/skills/ki-governance-anpassen/SKILL.md`. Urspruenglicher Skill-Name: `ki-governance-anpassen`.
...
- Konfiguration aus `.opencode/profile/ki-governance.md`
...
5. **Bei Änderungen am gemeinsamen Profil** (Unternehmensname, Branche, Jurisdiktionen,
   Praxiskontext):
   `./unternehmens-profil.md` schreiben
   und vermerken:
