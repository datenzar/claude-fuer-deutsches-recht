---
name: jurastudium-workflow-dokumentenintake
...
> Opencode-Port von `jurastudium/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
