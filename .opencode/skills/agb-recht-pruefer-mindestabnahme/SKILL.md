---
name: agb-recht-pruefer-mindestabnahme
...
> Opencode-Port von `agb-recht-pruefer/skills/mindestabnahme/SKILL.md`. Urspruenglicher Skill-Name: `mindestabnahme`.

# Mindestabnahme

## Wann verwenden

Nutze diesen Skill für **Mindestabnahme** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
