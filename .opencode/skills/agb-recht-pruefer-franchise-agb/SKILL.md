---
name: agb-recht-pruefer-franchise-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/franchise-agb/SKILL.md`. Urspruenglicher Skill-Name: `franchise-agb`.

# Franchise AGB

## Wann verwenden

Nutze diesen Skill für **Franchise AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
