---
name: agb-recht-pruefer-insolvenzverkauf-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/insolvenzverkauf-agb/SKILL.md`. Urspruenglicher Skill-Name: `insolvenzverkauf-agb`.

# Insolvenzverkauf AGB

## Wann verwenden

Nutze diesen Skill für **Insolvenzverkauf AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
