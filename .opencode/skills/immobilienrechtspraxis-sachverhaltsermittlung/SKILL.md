---
name: immobilienrechtspraxis-sachverhaltsermittlung
...
> Opencode-Port von `immobilienrechtspraxis/skills/sachverhaltsermittlung/SKILL.md`. Urspruenglicher Skill-Name: `sachverhaltsermittlung`.
