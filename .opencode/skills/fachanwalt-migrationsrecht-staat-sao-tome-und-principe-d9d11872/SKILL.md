---
name: fachanwalt-migrationsrecht-staat-sao-tome-und-principe-d9d11872
description: "Staaten- und Gebietscheck São Tomé und Príncipe: migrationsrechtlicher Workflow für Herkunfts-, Transit-, Dokumenten-, Visum-, Schutz-, Passbeschaffungs-, Rückführungs- und Aufenthaltstitelfragen mit Live-Quellencheck und optionaler spanischer Erklärung."
---

> Opencode-Port von `fachanwalt-migrationsrecht/skills/staat-sao-tome-und-principe-migrationscheck/SKILL.md`. Urspruenglicher Skill-Name: `staat-sao-tome-und-principe-migrationscheck`.
