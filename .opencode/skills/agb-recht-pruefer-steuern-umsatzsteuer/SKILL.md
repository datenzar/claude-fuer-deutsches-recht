---
name: agb-recht-pruefer-steuern-umsatzsteuer
...
> Opencode-Port von `agb-recht-pruefer/skills/steuern-umsatzsteuer/SKILL.md`. Urspruenglicher Skill-Name: `steuern-umsatzsteuer`.

# Steürn Umsatzsteür

## Wann verwenden

Nutze diesen Skill für **Steürn Umsatzsteür** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
