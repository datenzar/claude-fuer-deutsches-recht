---
name: agb-recht-pruefer-liquidated-damages
...
> Opencode-Port von `agb-recht-pruefer/skills/liquidated-damages/SKILL.md`. Urspruenglicher Skill-Name: `liquidated-damages`.

# Liquidated Damages

## Wann verwenden

Nutze diesen Skill für **Liquidated Damages** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
