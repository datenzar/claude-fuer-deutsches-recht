---
name: agb-recht-pruefer-abnahme-testing
...
> Opencode-Port von `agb-recht-pruefer/skills/abnahme-testing/SKILL.md`. Urspruenglicher Skill-Name: `abnahme-testing`.

# Abnahme Testing

## Wann verwenden

Nutze diesen Skill für **Abnahme Testing** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
