---
name: bank-rechtsabteilung-outsourcing-fintech-bank-as-a-service
...
> Opencode-Port von `bank-rechtsabteilung/skills/outsourcing-fintech-bank-as-a-service/SKILL.md`. Urspruenglicher Skill-Name: `outsourcing-fintech-bank-as-a-service`.
