---
name: agb-recht-pruefer-rollout-monitoring-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/rollout-monitoring-agb/SKILL.md`. Urspruenglicher Skill-Name: `rollout-monitoring-agb`.

# Rollout Monitoring AGB

## Wann verwenden

Nutze diesen Skill für **Rollout Monitoring AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
