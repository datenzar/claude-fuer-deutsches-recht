---
name: produktrecht-ist-das-ein-problem
...
> Opencode-Port von `produktrecht/skills/ist-das-ein-problem/SKILL.md`. Urspruenglicher Skill-Name: `ist-das-ein-problem`.

# /ist-das-ein-problem – Schnellprüfung

1. `.opencode/profile/produktrecht.md` → Risikokalibrierung laden.
...
`.opencode/profile/produktrecht.md` → `## Risikokalibrierung` lesen. Der ganze Sinn dieses Skills ist Muster-Erkennung gegen diese Tabelle.
