---
name: subsumtions-pruefer-output-alltagssprache-de
...
> Opencode-Port von `subsumtions-pruefer/skills/output-alltagssprache-de/SKILL.md`. Urspruenglicher Skill-Name: `output-alltagssprache-de`.
