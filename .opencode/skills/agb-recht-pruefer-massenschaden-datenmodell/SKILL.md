---
name: agb-recht-pruefer-massenschaden-datenmodell
...
> Opencode-Port von `agb-recht-pruefer/skills/massenschaden-datenmodell/SKILL.md`. Urspruenglicher Skill-Name: `massenschaden-datenmodell`.

# Massenschaden Datenmodell

## Wann verwenden

Nutze diesen Skill für **Massenschaden Datenmodell** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
