---
name: agb-recht-pruefer-vertraulichkeit-klausel
...
> Opencode-Port von `agb-recht-pruefer/skills/vertraulichkeit-klausel/SKILL.md`. Urspruenglicher Skill-Name: `vertraulichkeit-klausel`.

# Vertraulichkeit Klausel

## Wann verwenden

Nutze diesen Skill für **Vertraulichkeit Klausel** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
