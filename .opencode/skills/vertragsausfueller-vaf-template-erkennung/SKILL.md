---
name: vertragsausfueller-vaf-template-erkennung
...
> Opencode-Port von `vertragsausfueller/skills/vaf-template-erkennung/SKILL.md`. Urspruenglicher Skill-Name: `vaf-template-erkennung`.
