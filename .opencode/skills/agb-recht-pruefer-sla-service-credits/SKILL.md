---
name: agb-recht-pruefer-sla-service-credits
...
> Opencode-Port von `agb-recht-pruefer/skills/sla-service-credits/SKILL.md`. Urspruenglicher Skill-Name: `sla-service-credits`.

# SLA Service Credits

## Wann verwenden

Nutze diesen Skill für **SLA Service Credits** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
