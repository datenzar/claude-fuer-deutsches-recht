---
name: agb-recht-pruefer-ki-service-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/ki-service-agb/SKILL.md`. Urspruenglicher Skill-Name: `ki-service-agb`.

# KI Service AGB

## Wann verwenden

Nutze diesen Skill für **KI Service AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
