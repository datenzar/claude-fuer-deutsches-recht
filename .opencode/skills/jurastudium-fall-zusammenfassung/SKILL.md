---
name: jurastudium-fall-zusammenfassung
...
> Opencode-Port von `jurastudium/skills/fall-zusammenfassung/SKILL.md`. Urspruenglicher Skill-Name: `fall-zusammenfassung`.
...
4. **Lernprofil** aus `.opencode/profile/jurastudium.md` → Lernstil (Drill / Erklärung), Semester, Schwächebereiche
