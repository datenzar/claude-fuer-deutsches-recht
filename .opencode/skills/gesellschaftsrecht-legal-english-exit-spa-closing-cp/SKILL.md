---
name: gesellschaftsrecht-legal-english-exit-spa-closing-cp
description: "Erklaert Exit, SPA, signing, closing, Conditions Precedent, Long Stop Date, Closing Deliverables und Vollzugslogik bei Unternehmenstransaktionen."
---

> Opencode-Port von `gesellschaftsrecht-legal-english/skills/exit-spa-closing-cp/SKILL.md`. Urspruenglicher Skill-Name: `exit-spa-closing-cp`.
