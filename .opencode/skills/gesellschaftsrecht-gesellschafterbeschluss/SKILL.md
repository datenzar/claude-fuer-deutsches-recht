---
name: gesellschaftsrecht-gesellschafterbeschluss
...
> Opencode-Port von `gesellschaftsrecht/skills/gesellschafterbeschluss/SKILL.md`. Urspruenglicher Skill-Name: `gesellschafterbeschluss`.
