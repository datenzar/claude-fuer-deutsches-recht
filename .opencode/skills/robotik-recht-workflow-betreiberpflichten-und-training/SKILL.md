---
name: robotik-recht-workflow-betreiberpflichten-und-training
...
> Opencode-Port von `robotik-recht/skills/workflow-betreiberpflichten-und-training/SKILL.md`. Urspruenglicher Skill-Name: `workflow-betreiberpflichten-und-training`.
