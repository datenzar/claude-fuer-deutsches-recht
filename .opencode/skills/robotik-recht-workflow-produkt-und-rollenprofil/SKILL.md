---
name: robotik-recht-workflow-produkt-und-rollenprofil
...
> Opencode-Port von `robotik-recht/skills/workflow-produkt-und-rollenprofil/SKILL.md`. Urspruenglicher Skill-Name: `workflow-produkt-und-rollenprofil`.
