---
name: fachanwalt-familienrecht-fragebogen-versorgungsausgleic-4af214b8
...
> Opencode-Port von `fachanwalt-familienrecht/skills/fragebogen-versorgungsausgleich-ausfuellen/SKILL.md`. Urspruenglicher Skill-Name: `fragebogen-versorgungsausgleich-ausfuellen`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Fragebogen Versorgungsausgleich ausfüllen..
