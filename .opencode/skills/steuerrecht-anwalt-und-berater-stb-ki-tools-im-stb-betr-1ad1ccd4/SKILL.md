...
| opencode (Anthropic) | Recherche, Text | Achtung | Pruefen |
...
- Bei ChatGPT/opencode in Konsumfassung: Mandantendaten zwingend anonymisieren / pseudonymisieren; Trainings-Opt-Out aktivieren; bei Geschaeftskonten mit AVV (z.B. ChatGPT Enterprise, opencode for Work) sind die Anforderungen erfuellbar, jeweils Vertragsstand pruefen.
