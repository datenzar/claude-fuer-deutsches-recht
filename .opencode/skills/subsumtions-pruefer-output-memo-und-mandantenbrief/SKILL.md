---
name: subsumtions-pruefer-output-memo-und-mandantenbrief
...
> Opencode-Port von `subsumtions-pruefer/skills/output-memo-und-mandantenbrief/SKILL.md`. Urspruenglicher Skill-Name: `output-memo-und-mandantenbrief`.
