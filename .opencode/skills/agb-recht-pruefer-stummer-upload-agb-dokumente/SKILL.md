---
name: agb-recht-pruefer-stummer-upload-agb-dokumente
...
> Opencode-Port von `agb-recht-pruefer/skills/stummer-upload-agb-dokumente/SKILL.md`. Urspruenglicher Skill-Name: `stummer-upload-agb-dokumente`.

# Stummer Upload AGB Dokumente

## Wann verwenden

Nutze diesen Skill für **Stummer Upload AGB Dokumente** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
