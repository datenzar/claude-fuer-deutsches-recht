---
name: krankenhausrecht-krankenhausreform-leistungsgruppen-routing
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Krankenhausreform Leistungsgruppen Routing."
---

> Opencode-Port von `krankenhausrecht/skills/krankenhausreform-leistungsgruppen-routing/SKILL.md`. Urspruenglicher Skill-Name: `krankenhausreform-leistungsgruppen-routing`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Krankenhausreform Leistungsgruppen Routing..
