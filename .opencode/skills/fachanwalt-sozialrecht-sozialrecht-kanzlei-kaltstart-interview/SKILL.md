---
name: fachanwalt-sozialrecht-sozialrecht-kanzlei-kaltstart-interview
description: "Kaltstart-Interview für die sozialrechtliche Kanzlei. Erfragt Schwerpunktbereiche (Buergergeld SGB II / SGB IX Schwerbehinderung / SGB V Krankenversicherung / SGB XI Pflege / Asylbewerberleistungsgesetz) zuständige Sozialgerichte typische Mandate (Bescheid-Widerspruch / Klage / Eilrechtsschutz) Prozesskostenhilfe-Quote Sekretariatslast Aktenstruktur-Konvention Versandwege (beA / Post / ePostfach Behoerde) Eskalation. Schreibt Profil nach .opencode/profile/sozialrecht-kanzlei.md. Mit --redo neu interviewen."
---

> Opencode-Port von `fachanwalt-sozialrecht/skills/sozialrecht-kanzlei-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `sozialrecht-kanzlei-kaltstart-interview`.

# /sozialrecht-kanzlei:sozialrecht-kanzlei-kaltstart-interview

## Ablauf

1. Konfigurationsdatei `.opencode/profile/sozialrecht-kanzlei.md` prüfen.
