---
name: mietrecht-mietsenkungsverlangen
...
> Opencode-Port von `mietrecht/skills/mietsenkungsverlangen/SKILL.md`. Urspruenglicher Skill-Name: `mietsenkungsverlangen`.
