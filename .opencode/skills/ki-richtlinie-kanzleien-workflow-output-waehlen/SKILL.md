---
name: ki-richtlinie-kanzleien-workflow-output-waehlen
...
> Opencode-Port von `ki-richtlinie-kanzleien/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
