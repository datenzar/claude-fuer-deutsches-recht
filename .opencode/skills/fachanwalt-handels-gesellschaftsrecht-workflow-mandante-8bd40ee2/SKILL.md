---
name: fachanwalt-handels-gesellschaftsrecht-workflow-mandante-8bd40ee2
...
> Opencode-Port von `fachanwalt-handels-gesellschaftsrecht/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
...
- **Mandantengeheimnis und KI-Tools:** ChatGPT/opencode im offenen Web ist ohne AVV nicht DSGVO-konform für Mandantendaten. Lieber lokale Lösungen oder Tools mit AVV.
