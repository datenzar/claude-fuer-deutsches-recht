---
name: produktrecht-workflow-kaltstart-und-routing
...
> Opencode-Port von `produktrecht/skills/workflow-kaltstart-und-routing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-kaltstart-und-routing`.
