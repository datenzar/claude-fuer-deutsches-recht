---
name: goae-gebuehrenordnung-aerzte-livecheck-goae-text-und-reformstand
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Livecheck GOÄ Text und Reformstand."
---

> Opencode-Port von `goae-gebuehrenordnung-aerzte/skills/livecheck-goae-text-und-reformstand/SKILL.md`. Urspruenglicher Skill-Name: `livecheck-goae-text-und-reformstand`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Livecheck GOÄ Text und Reformstand..
