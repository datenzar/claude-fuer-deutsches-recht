---
name: agb-recht-pruefer-entgelt-nebenkosten-service-fees
...
> Opencode-Port von `agb-recht-pruefer/skills/entgelt-nebenkosten-service-fees/SKILL.md`. Urspruenglicher Skill-Name: `entgelt-nebenkosten-service-fees`.

# Entgelt Nebenkosten Service Fees

## Wann verwenden

Nutze diesen Skill für **Entgelt Nebenkosten Service Fees** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
