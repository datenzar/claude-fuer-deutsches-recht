---
name: agb-recht-pruefer-agb-risikoklassifizierung-ampel
...
> Opencode-Port von `agb-recht-pruefer/skills/agb-risikoklassifizierung-ampel/SKILL.md`. Urspruenglicher Skill-Name: `agb-risikoklassifizierung-ampel`.

# AGB Risikoklassifizierung Ampel

## Wann verwenden

Nutze diesen Skill für **AGB Risikoklassifizierung Ampel** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
