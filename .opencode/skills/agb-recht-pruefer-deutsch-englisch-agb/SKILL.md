---
name: agb-recht-pruefer-deutsch-englisch-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/deutsch-englisch-agb/SKILL.md`. Urspruenglicher Skill-Name: `deutsch-englisch-agb`.

# Deutsch Englisch AGB

## Wann verwenden

Nutze diesen Skill für **Deutsch Englisch AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
