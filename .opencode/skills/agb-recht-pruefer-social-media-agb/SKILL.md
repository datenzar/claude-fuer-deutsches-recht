---
name: agb-recht-pruefer-social-media-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/social-media-agb/SKILL.md`. Urspruenglicher Skill-Name: `social-media-agb`.

# Social Media AGB

## Wann verwenden

Nutze diesen Skill für **Social Media AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
