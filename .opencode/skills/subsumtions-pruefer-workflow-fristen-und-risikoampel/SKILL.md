---
name: subsumtions-pruefer-workflow-fristen-und-risikoampel
...
> Opencode-Port von `subsumtions-pruefer/skills/workflow-fristen-und-risikoampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fristen-und-risikoampel`.
