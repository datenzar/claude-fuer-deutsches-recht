---
name: insolvenzrecht-workflow-redteam-qualitygate
...
> Opencode-Port von `insolvenzrecht/skills/workflow-redteam-qualitygate/SKILL.md`. Urspruenglicher Skill-Name: `workflow-redteam-qualitygate`.
