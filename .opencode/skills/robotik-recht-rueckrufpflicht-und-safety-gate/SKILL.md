---
name: robotik-recht-rueckrufpflicht-und-safety-gate
description: "Prüft Rückruf, Warnung, Korrekturmaßnahme, Safety-Gate-Meldung, Kundenkommunikation und Behördenunterrichtung."
---

> Opencode-Port von `robotik-recht/skills/rueckrufpflicht-und-safety-gate/SKILL.md`. Urspruenglicher Skill-Name: `rueckrufpflicht-und-safety-gate`.
