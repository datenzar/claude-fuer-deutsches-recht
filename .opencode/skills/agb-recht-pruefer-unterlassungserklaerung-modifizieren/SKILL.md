---
name: agb-recht-pruefer-unterlassungserklaerung-modifizieren
...
> Opencode-Port von `agb-recht-pruefer/skills/unterlassungserklaerung-modifizieren/SKILL.md`. Urspruenglicher Skill-Name: `unterlassungserklaerung-modifizieren`.

# Unterlassungserklärung Modifizieren

## Wann verwenden

Nutze diesen Skill für **Unterlassungserklärung Modifizieren** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
