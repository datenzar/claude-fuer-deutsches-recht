---
name: fachanwalt-familienrecht-soldatenversorgung-bundeswehr-81438ffb
...
> Opencode-Port von `fachanwalt-familienrecht/skills/soldatenversorgung-bundeswehr-schnittstelle/SKILL.md`. Urspruenglicher Skill-Name: `soldatenversorgung-bundeswehr-schnittstelle`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Soldatenversorgung Bundeswehr Schnittstelle: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
