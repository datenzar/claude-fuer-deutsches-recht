---
name: subsumtions-pruefer-output-juristisch-gestochen-de
...
> Opencode-Port von `subsumtions-pruefer/skills/output-juristisch-gestochen-de/SKILL.md`. Urspruenglicher Skill-Name: `output-juristisch-gestochen-de`.
