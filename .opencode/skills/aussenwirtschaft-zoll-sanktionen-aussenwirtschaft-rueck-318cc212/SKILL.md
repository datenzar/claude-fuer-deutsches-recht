---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-rueck-318cc212
description: "Vertiefter Skill fuer Rueckwaren Erlass Erstattung. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-rueckwaren-erlass-erstattung/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-rueckwaren-erlass-erstattung`.

# Rueckwaren Erlass Erstattung

## Zweck

Dieser Skill behandelt **Rueckwaren Erlass Erstattung** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
