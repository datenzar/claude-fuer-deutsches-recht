---
name: strafzumessung-workflow-anschluss-skills-router
...
> Opencode-Port von `strafzumessung/skills/workflow-anschluss-skills-router/SKILL.md`. Urspruenglicher Skill-Name: `workflow-anschluss-skills-router`.
