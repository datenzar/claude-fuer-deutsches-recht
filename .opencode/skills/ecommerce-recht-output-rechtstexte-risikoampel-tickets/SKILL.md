---
name: ecommerce-recht-output-rechtstexte-risikoampel-tickets
...
> Opencode-Port von `ecommerce-recht/skills/output-rechtstexte-risikoampel-tickets/SKILL.md`. Urspruenglicher Skill-Name: `output-rechtstexte-risikoampel-tickets`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Output Rechtstexte Risikoampel Tickets..
