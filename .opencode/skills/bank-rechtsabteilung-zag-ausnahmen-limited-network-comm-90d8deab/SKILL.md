---
name: bank-rechtsabteilung-zag-ausnahmen-limited-network-comm-90d8deab
...
> Opencode-Port von `bank-rechtsabteilung/skills/zag-ausnahmen-limited-network-commercial-agent/SKILL.md`. Urspruenglicher Skill-Name: `zag-ausnahmen-limited-network-commercial-agent`.
