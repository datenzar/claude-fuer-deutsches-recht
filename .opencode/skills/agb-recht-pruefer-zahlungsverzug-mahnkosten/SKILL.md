---
name: agb-recht-pruefer-zahlungsverzug-mahnkosten
...
> Opencode-Port von `agb-recht-pruefer/skills/zahlungsverzug-mahnkosten/SKILL.md`. Urspruenglicher Skill-Name: `zahlungsverzug-mahnkosten`.

# Zahlungsverzug Mahnkosten

## Wann verwenden

Nutze diesen Skill für **Zahlungsverzug Mahnkosten** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
