---
name: robotik-recht-workflow-beweismatrix-und-logauswertung
...
> Opencode-Port von `robotik-recht/skills/workflow-beweismatrix-und-logauswertung/SKILL.md`. Urspruenglicher Skill-Name: `workflow-beweismatrix-und-logauswertung`.
