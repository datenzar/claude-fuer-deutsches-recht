---
name: agb-recht-pruefer-security-incidents
...
> Opencode-Port von `agb-recht-pruefer/skills/security-incidents/SKILL.md`. Urspruenglicher Skill-Name: `security-incidents`.

# Security Incidents

## Wann verwenden

Nutze diesen Skill für **Security Incidents** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
