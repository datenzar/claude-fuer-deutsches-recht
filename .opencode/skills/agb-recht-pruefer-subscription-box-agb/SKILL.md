---
name: agb-recht-pruefer-subscription-box-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/subscription-box-agb/SKILL.md`. Urspruenglicher Skill-Name: `subscription-box-agb`.

# Subscription Box AGB

## Wann verwenden

Nutze diesen Skill für **Subscription Box AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
