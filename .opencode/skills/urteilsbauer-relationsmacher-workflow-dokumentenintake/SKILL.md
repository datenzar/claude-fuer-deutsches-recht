---
name: urteilsbauer-relationsmacher-workflow-dokumentenintake
...
> Opencode-Port von `urteilsbauer-relationsmacher/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
