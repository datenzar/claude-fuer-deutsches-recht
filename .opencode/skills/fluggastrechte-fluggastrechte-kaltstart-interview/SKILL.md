---
name: fluggastrechte-fluggastrechte-kaltstart-interview
description: "Kaltstart-Interview für das Fluggastrechte-Plugin. Klaert Anwendungsrolle (eigener Fluggastrechte-Anspruch / Vertretung Familie / Mitreisende). Erfasst Buchungsstammdaten Vertragspartner (Airline IATA-Code) und Reiseplan-Konvention. Schreibt das Profil nach .opencode/profile/fluggastrechte.md. Bei Erstinstallation laufen lassen. Mit --redo neu interviewen. Disclaimer Selbstmandat ersetzt nicht anwaltliche Prüfung im Streitfall."
---

> Opencode-Port von `fluggastrechte/skills/fluggastrechte-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `fluggastrechte-kaltstart-interview`.

# /fluggastrechte:fluggastrechte-kaltstart-interview

## Ablauf

1. Datei `.opencode/profile/fluggastrechte.md` prüfen.
