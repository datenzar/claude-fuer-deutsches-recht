---
name: vertragsrecht-lieferantenvertrag-pruefung
...
> Opencode-Port von `vertragsrecht/skills/lieferantenvertrag-pruefung/SKILL.md`. Urspruenglicher Skill-Name: `lieferantenvertrag-pruefung`.

# Lieferanten-/Dienstleistervertrag-Prüfung

## Zweck

Einen Lieferanten- oder Dienstleistervertrag gegen das tatsächlich verwendete Playbook der Rechtsabteilung prüfen (in `.opencode/profile/vertragsrecht.md`), jede abweichende Klausel identifizieren und dem Juristen mitteilen, was zu tun ist – mit konkreten Redline-Formulierungen, keinen vagen "Überarbeitung erwägen"-Empfehlungen. Maßgeblich: §§ 611, 631 BGB (Dienst-/Werkvertrag), §§ 434 ff. BGB (Kauf), §§ 305–310 BGB (AGB-Recht), LkSG, ggf. CISG.
...
**Vor dem Vertragslesen** `.opencode/profile/vertragsrecht.md` lesen. Falls fehlend oder Platzhalter:
