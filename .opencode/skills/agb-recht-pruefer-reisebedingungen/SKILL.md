---
name: agb-recht-pruefer-reisebedingungen
...
> Opencode-Port von `agb-recht-pruefer/skills/reisebedingungen/SKILL.md`. Urspruenglicher Skill-Name: `reisebedingungen`.

# Reisebedingungen

## Wann verwenden

Nutze diesen Skill für **Reisebedingungen** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
