---
name: agb-recht-pruefer-rechtsfolgen-rueckabwicklung-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/rechtsfolgen-rueckabwicklung-agb/SKILL.md`. Urspruenglicher Skill-Name: `rechtsfolgen-rueckabwicklung-agb`.

# Rechtsfolgen Rückabwicklung AGB

## Wann verwenden

Nutze diesen Skill für **Rechtsfolgen Rückabwicklung AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
