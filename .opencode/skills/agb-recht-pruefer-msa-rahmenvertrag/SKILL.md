---
name: agb-recht-pruefer-msa-rahmenvertrag
...
> Opencode-Port von `agb-recht-pruefer/skills/msa-rahmenvertrag/SKILL.md`. Urspruenglicher Skill-Name: `msa-rahmenvertrag`.

# MSA Rahmenvertrag

## Wann verwenden

Nutze diesen Skill für **MSA Rahmenvertrag** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
