---
name: fachanwalt-migrationsrecht-workflow-dublin-geas-start
description: "Dublin/GEAS Start: Workflow-Skill für Migrationsrecht; prüft Eurodac, Zuständigkeit, Fristen, Vulnerabilität und Eilantrag; mit Statusmatrix, Fristenrettung, Staatenbezug, Quellencheck und nutzbarem Output."
---

> Opencode-Port von `fachanwalt-migrationsrecht/skills/workflow-dublin-geas-start/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dublin-geas-start`.
