---
name: vertragsausfueller-vaf-track-changes-nur-nach-frage
...
> Opencode-Port von `vertragsausfueller/skills/vaf-track-changes-nur-nach-frage/SKILL.md`. Urspruenglicher Skill-Name: `vaf-track-changes-nur-nach-frage`.
