---
name: prozessrecht-workflow-output-waehlen
...
> Opencode-Port von `prozessrecht/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
