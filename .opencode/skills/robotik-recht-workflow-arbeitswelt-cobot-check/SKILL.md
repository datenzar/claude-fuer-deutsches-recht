---
name: robotik-recht-workflow-arbeitswelt-cobot-check
...
> Opencode-Port von `robotik-recht/skills/workflow-arbeitswelt-cobot-check/SKILL.md`. Urspruenglicher Skill-Name: `workflow-arbeitswelt-cobot-check`.
