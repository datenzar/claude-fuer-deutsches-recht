---
name: nachbarschaftsstreit-pruefer-landesnachbarrecht-router
...
> Opencode-Port von `nachbarschaftsstreit-pruefer/skills/landesnachbarrecht-router/SKILL.md`. Urspruenglicher Skill-Name: `landesnachbarrecht-router`.
