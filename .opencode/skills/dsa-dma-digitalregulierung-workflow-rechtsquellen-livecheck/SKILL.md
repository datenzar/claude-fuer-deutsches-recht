---
name: dsa-dma-digitalregulierung-workflow-rechtsquellen-livecheck
...
> Opencode-Port von `dsa-dma-digitalregulierung/skills/workflow-rechtsquellen-livecheck/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsquellen-livecheck`.
