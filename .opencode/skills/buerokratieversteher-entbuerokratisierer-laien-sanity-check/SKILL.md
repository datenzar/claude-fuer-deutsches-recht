---
name: buerokratieversteher-entbuerokratisierer-laien-sanity-check
description: "Letzte Prüfung: Habe ich verstanden, was passiert, welche Frist läuft, was ich sende und was ich nicht sende?"
---

> Opencode-Port von `buerokratieversteher-entbuerokratisierer/skills/laien-sanity-check/SKILL.md`. Urspruenglicher Skill-Name: `laien-sanity-check`.
