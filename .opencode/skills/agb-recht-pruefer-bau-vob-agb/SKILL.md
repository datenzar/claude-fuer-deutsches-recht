---
name: agb-recht-pruefer-bau-vob-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/bau-vob-agb/SKILL.md`. Urspruenglicher Skill-Name: `bau-vob-agb`.

# Bau VOB/B AGB

## Wann verwenden

Nutze diesen Skill für **Bau VOB/B AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
