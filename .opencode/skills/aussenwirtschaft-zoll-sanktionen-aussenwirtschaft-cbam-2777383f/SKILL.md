---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-cbam-2777383f
description: "Vertiefter Skill fuer CBAM-Zertifikate, Kostenmodell, Einkaufsdaten und Controlling-Schnittstelle. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-cbam-zertifikate-kosten/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-cbam-zertifikate-kosten`.

# CBAM Zertifikate Kosten

## Zweck

Dieser Skill behandelt **CBAM-Zertifikate, Kostenmodell, Einkaufsdaten und Controlling-Schnittstelle** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
