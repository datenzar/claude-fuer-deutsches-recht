---
name: agb-recht-pruefer-wartung-maintenance
...
> Opencode-Port von `agb-recht-pruefer/skills/wartung-maintenance/SKILL.md`. Urspruenglicher Skill-Name: `wartung-maintenance`.

# Wartung Maintenance

## Wann verwenden

Nutze diesen Skill für **Wartung Maintenance** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
