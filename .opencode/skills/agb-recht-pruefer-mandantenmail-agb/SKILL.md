---
name: agb-recht-pruefer-mandantenmail-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/mandantenmail-agb/SKILL.md`. Urspruenglicher Skill-Name: `mandantenmail-agb`.

# Mandantenmail AGB

## Wann verwenden

Nutze diesen Skill für **Mandantenmail AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
