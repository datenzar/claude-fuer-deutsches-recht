---
name: robotik-recht-workflow-unfall-incident-response
...
> Opencode-Port von `robotik-recht/skills/workflow-unfall-incident-response/SKILL.md`. Urspruenglicher Skill-Name: `workflow-unfall-incident-response`.
