---
name: dsa-dma-digitalregulierung-dsa-dark-patterns-anti-design
...
> Opencode-Port von `dsa-dma-digitalregulierung/skills/dsa-dark-patterns-anti-design/SKILL.md`. Urspruenglicher Skill-Name: `dsa-dark-patterns-anti-design`.
