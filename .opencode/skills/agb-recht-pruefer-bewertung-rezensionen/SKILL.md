---
name: agb-recht-pruefer-bewertung-rezensionen
...
> Opencode-Port von `agb-recht-pruefer/skills/bewertung-rezensionen/SKILL.md`. Urspruenglicher Skill-Name: `bewertung-rezensionen`.

# Bewertung Rezensionen

## Wann verwenden

Nutze diesen Skill für **Bewertung Rezensionen** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
