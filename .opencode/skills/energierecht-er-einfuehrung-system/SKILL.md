---
name: energierecht-er-einfuehrung-system
...
> Opencode-Port von `energierecht/skills/er-einfuehrung-system/SKILL.md`. Urspruenglicher Skill-Name: `er-einfuehrung-system`.
