---
name: hausarbeitenmacher-hausarbeit-workflow-start
...
> Opencode-Port von `hausarbeitenmacher/skills/hausarbeit-workflow-start/SKILL.md`. Urspruenglicher Skill-Name: `hausarbeit-workflow-start`.
