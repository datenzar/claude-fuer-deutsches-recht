---
name: fluggastrechte-workflow-fristen-und-risikoampel
...
> Opencode-Port von `fluggastrechte/skills/workflow-fristen-und-risikoampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fristen-und-risikoampel`.
