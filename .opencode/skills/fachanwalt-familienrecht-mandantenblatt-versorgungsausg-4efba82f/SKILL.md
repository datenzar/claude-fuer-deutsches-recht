---
name: fachanwalt-familienrecht-mandantenblatt-versorgungsausg-4efba82f
...
> Opencode-Port von `fachanwalt-familienrecht/skills/mandantenblatt-versorgungsausgleich-in-einfacher-sprache/SKILL.md`. Urspruenglicher Skill-Name: `mandantenblatt-versorgungsausgleich-in-einfacher-sprache`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Mandantenblatt Versorgungsausgleich in einfacher Sprache: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
