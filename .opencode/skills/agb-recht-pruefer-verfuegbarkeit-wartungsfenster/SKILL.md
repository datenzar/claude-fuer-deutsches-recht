---
name: agb-recht-pruefer-verfuegbarkeit-wartungsfenster
...
> Opencode-Port von `agb-recht-pruefer/skills/verfuegbarkeit-wartungsfenster/SKILL.md`. Urspruenglicher Skill-Name: `verfuegbarkeit-wartungsfenster`.

# Verfügbarkeit Wartungsfenster

## Wann verwenden

Nutze diesen Skill für **Verfügbarkeit Wartungsfenster** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
