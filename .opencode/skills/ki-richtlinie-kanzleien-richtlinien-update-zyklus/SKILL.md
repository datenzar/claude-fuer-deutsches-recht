---
name: ki-richtlinie-kanzleien-richtlinien-update-zyklus
...
> Opencode-Port von `ki-richtlinie-kanzleien/skills/richtlinien-update-zyklus/SKILL.md`. Urspruenglicher Skill-Name: `richtlinien-update-zyklus`.
