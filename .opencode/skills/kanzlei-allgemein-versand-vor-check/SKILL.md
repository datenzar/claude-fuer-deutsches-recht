---
name: kanzlei-allgemein-versand-vor-check
...
> Opencode-Port von `kanzlei-allgemein/skills/versand-vor-check/SKILL.md`. Urspruenglicher Skill-Name: `versand-vor-check`.
