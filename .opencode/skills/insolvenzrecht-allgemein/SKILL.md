...
> Opencode-Port von `insolvenzrecht/skills/allgemein/SKILL.md`. Urspruenglicher Skill-Name: `allgemein`.
...
| `insolvenzrecht-kaltstart-interview` | Kaltstart-Interview für das Insolvenzrecht-Plugin. Befüllt das Praxisprofil unter .opencode/profile/insolvenzrecht.md mit Angaben zur Rolle (Insolvenzverwalter / Sachwalter /… |
