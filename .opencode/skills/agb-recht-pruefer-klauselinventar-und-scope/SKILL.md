---
name: agb-recht-pruefer-klauselinventar-und-scope
...
> Opencode-Port von `agb-recht-pruefer/skills/klauselinventar-und-scope/SKILL.md`. Urspruenglicher Skill-Name: `klauselinventar-und-scope`.

# Klauselinventar und Scope

## Wann verwenden

Nutze diesen Skill für **Klauselinventar und Scope** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
