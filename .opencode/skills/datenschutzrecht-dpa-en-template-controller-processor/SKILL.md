---
name: datenschutzrecht-dpa-en-template-controller-processor
...
> Opencode-Port von `datenschutzrecht/skills/dpa-en-template-controller-processor/SKILL.md`. Urspruenglicher Skill-Name: `dpa-en-template-controller-processor`.
