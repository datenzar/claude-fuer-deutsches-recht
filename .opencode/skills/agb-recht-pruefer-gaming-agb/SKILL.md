---
name: agb-recht-pruefer-gaming-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/gaming-agb/SKILL.md`. Urspruenglicher Skill-Name: `gaming-agb`.

# Gaming AGB

## Wann verwenden

Nutze diesen Skill für **Gaming AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
