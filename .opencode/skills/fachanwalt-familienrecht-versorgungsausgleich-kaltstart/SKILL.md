---
name: fachanwalt-familienrecht-versorgungsausgleich-kaltstart
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Versorgungsausgleich Kaltstart."
---

> Opencode-Port von `fachanwalt-familienrecht/skills/versorgungsausgleich-kaltstart/SKILL.md`. Urspruenglicher Skill-Name: `versorgungsausgleich-kaltstart`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Versorgungsausgleich Kaltstart..
