---
name: arbeitsrecht-kuendigungs-pruefung
...
> Opencode-Port von `arbeitsrecht/skills/kuendigungs-pruefung/SKILL.md`. Urspruenglicher Skill-Name: `kuendigungs-pruefung`.
...
- `.opencode/profile/arbeitsrecht.md` → Kündigungsregeln, Eskalation
