---
name: regulatorisches-recht-regulatorisches-recht-kaltstart-interview
...
> Opencode-Port von `regulatorisches-recht/skills/regulatorisches-recht-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `regulatorisches-recht-kaltstart-interview`.

# Ersteinrichtung – Regulatorisches Recht

## Zweck

Dieser Skill konfiguriert das Plugin einmalig auf Ihre Praxis: Welche Behörden beobachten Sie? Welche Richtlinien haben Sie? Was ist für Sie wesentlich? Das Ergebnis ist ein befülltes Praxisprofil unter `.opencode/profile/regulatorisches-recht.md`, auf das alle anderen Skills zugreifen.
...
```
Gibt es bereits ein Unternehmensprofil unter ./unternehmens-profil.md?
```
...
Die erfassten Informationen als befülltes Praxisprofil zusammenfassen, dem Nutzer zur Bestätigung vorlegen und dann in `.opencode/profile/regulatorisches-recht.md` schreiben.
