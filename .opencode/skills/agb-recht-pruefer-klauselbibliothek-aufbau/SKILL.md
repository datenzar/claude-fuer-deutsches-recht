---
name: agb-recht-pruefer-klauselbibliothek-aufbau
...
> Opencode-Port von `agb-recht-pruefer/skills/klauselbibliothek-aufbau/SKILL.md`. Urspruenglicher Skill-Name: `klauselbibliothek-aufbau`.

# Klauselbibliothek Aufbau

## Wann verwenden

Nutze diesen Skill für **Klauselbibliothek Aufbau** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
