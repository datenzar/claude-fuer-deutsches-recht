---
name: bank-rechtsabteilung-it-sicherheit-cloud-vertraege
...
> Opencode-Port von `bank-rechtsabteilung/skills/it-sicherheit-cloud-vertraege/SKILL.md`. Urspruenglicher Skill-Name: `it-sicherheit-cloud-vertraege`.
