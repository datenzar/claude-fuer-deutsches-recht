---
name: fluggastrechte-workflow-mandantenkommunikation
...
> Opencode-Port von `fluggastrechte/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
