---
name: robotik-recht-logging-und-traceability-robotik
...
> Opencode-Port von `robotik-recht/skills/logging-und-traceability-robotik/SKILL.md`. Urspruenglicher Skill-Name: `logging-und-traceability-robotik`.
