---
name: nda-abgleich-nda-vor-m-a-data-room
...
> Opencode-Port von `nda-abgleich/skills/nda-vor-m-a-data-room/SKILL.md`. Urspruenglicher Skill-Name: `nda-vor-m-a-data-room`.
