---
name: agb-recht-pruefer-klausel-entwerfen-aggressiv
...
> Opencode-Port von `agb-recht-pruefer/skills/klausel-entwerfen-aggressiv/SKILL.md`. Urspruenglicher Skill-Name: `klausel-entwerfen-aggressiv`.

# Klausel Entwerfen Aggressiv

## Wann verwenden

Nutze diesen Skill für **Klausel Entwerfen Aggressiv** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
