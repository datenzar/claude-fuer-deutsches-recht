---
name: agb-recht-pruefer-definitionen-glossar-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/definitionen-glossar-agb/SKILL.md`. Urspruenglicher Skill-Name: `definitionen-glossar-agb`.

# Definitionen Glossar AGB

## Wann verwenden

Nutze diesen Skill für **Definitionen Glossar AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
