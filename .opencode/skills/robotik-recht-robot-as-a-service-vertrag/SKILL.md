---
name: robotik-recht-robot-as-a-service-vertrag
...
> Opencode-Port von `robotik-recht/skills/robot-as-a-service-vertrag/SKILL.md`. Urspruenglicher Skill-Name: `robot-as-a-service-vertrag`.
