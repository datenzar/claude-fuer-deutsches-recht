---
name: arbeitsrecht-lohn-arbeitszeit-fragen
...
> Opencode-Port von `arbeitsrecht/skills/lohn-arbeitszeit-fragen/SKILL.md`. Urspruenglicher Skill-Name: `lohn-arbeitszeit-fragen`.
...
- `.opencode/profile/arbeitsrecht.md` → Standort, Tarifbindung, Arbeitszeitmodelle
