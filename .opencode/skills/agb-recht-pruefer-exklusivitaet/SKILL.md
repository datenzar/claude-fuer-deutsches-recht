---
name: agb-recht-pruefer-exklusivitaet
...
> Opencode-Port von `agb-recht-pruefer/skills/exklusivitaet/SKILL.md`. Urspruenglicher Skill-Name: `exklusivitaet`.

# Exklusivität

## Wann verwenden

Nutze diesen Skill für **Exklusivität** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
