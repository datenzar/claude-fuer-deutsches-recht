---
name: immobilienrechtspraxis-case-management
...
> Opencode-Port von `immobilienrechtspraxis/skills/case-management/SKILL.md`. Urspruenglicher Skill-Name: `case-management`.
