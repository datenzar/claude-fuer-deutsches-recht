---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-expor-965aad85
description: "Vertiefter Skill fuer Exportkontrollklauseln Vertrag. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-exportkontrollklauseln-vertrag/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-exportkontrollklauseln-vertrag`.

# Exportkontrollklauseln Vertrag

## Zweck

Dieser Skill behandelt **Exportkontrollklauseln Vertrag** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
