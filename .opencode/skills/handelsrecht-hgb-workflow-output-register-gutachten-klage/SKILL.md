---
name: handelsrecht-hgb-workflow-output-register-gutachten-klage
description: "Erstellt Registeranmeldungsskizze, Gutachten, Klagebaustein, Rügebrief, Protokoll oder Mandantenbrief."
---

> Opencode-Port von `handelsrecht-hgb/skills/workflow-output-register-gutachten-klage/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-register-gutachten-klage`.
