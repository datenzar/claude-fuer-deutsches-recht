---
name: gesellschaftsrecht-handelsregisteranmeldung
...
> Opencode-Port von `gesellschaftsrecht/skills/handelsregisteranmeldung/SKILL.md`. Urspruenglicher Skill-Name: `handelsregisteranmeldung`.
