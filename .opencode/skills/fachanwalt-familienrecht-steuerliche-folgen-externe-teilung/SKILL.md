---
name: fachanwalt-familienrecht-steuerliche-folgen-externe-teilung
...
> Opencode-Port von `fachanwalt-familienrecht/skills/steuerliche-folgen-externe-teilung/SKILL.md`. Urspruenglicher Skill-Name: `steuerliche-folgen-externe-teilung`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Steuerliche Folgen externe Teilung: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
