---
name: produktrecht-workflow-redteam-qualitygate
...
> Opencode-Port von `produktrecht/skills/workflow-redteam-qualitygate/SKILL.md`. Urspruenglicher Skill-Name: `workflow-redteam-qualitygate`.
