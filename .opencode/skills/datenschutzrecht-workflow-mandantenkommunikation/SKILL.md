---
name: datenschutzrecht-workflow-mandantenkommunikation
...
> Opencode-Port von `datenschutzrecht/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
