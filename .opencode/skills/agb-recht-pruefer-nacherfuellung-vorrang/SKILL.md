---
name: agb-recht-pruefer-nacherfuellung-vorrang
...
> Opencode-Port von `agb-recht-pruefer/skills/nacherfuellung-vorrang/SKILL.md`. Urspruenglicher Skill-Name: `nacherfuellung-vorrang`.

# Nacherfüllung Vorrang

## Wann verwenden

Nutze diesen Skill für **Nacherfüllung Vorrang** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
