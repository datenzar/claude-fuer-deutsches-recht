---
name: phishing-vorfall-pruefer-workflow-output-waehlen
...
> Opencode-Port von `phishing-vorfall-pruefer/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
