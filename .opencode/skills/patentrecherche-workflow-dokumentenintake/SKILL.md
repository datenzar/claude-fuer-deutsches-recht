---
name: patentrecherche-workflow-dokumentenintake
...
> Opencode-Port von `patentrecherche/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
