---
name: agb-recht-pruefer-fitnessstudio-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/fitnessstudio-agb/SKILL.md`. Urspruenglicher Skill-Name: `fitnessstudio-agb`.

# Fitnessstudio AGB

## Wann verwenden

Nutze diesen Skill für **Fitnessstudio AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
