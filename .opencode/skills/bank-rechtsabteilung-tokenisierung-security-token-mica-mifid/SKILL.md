---
name: bank-rechtsabteilung-tokenisierung-security-token-mica-mifid
...
> Opencode-Port von `bank-rechtsabteilung/skills/tokenisierung-security-token-mica-mifid/SKILL.md`. Urspruenglicher Skill-Name: `tokenisierung-security-token-mica-mifid`.
