---
name: agb-recht-pruefer-architekten-ingenieur-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/architekten-ingenieur-agb/SKILL.md`. Urspruenglicher Skill-Name: `architekten-ingenieur-agb`.

# Architekten Ingenieur AGB

## Wann verwenden

Nutze diesen Skill für **Architekten Ingenieur AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
