---
name: agb-recht-pruefer-logistik-spedition-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/logistik-spedition-agb/SKILL.md`. Urspruenglicher Skill-Name: `logistik-spedition-agb`.

# Logistik Spedition AGB

## Wann verwenden

Nutze diesen Skill für **Logistik Spedition AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
