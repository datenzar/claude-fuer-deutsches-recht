---
name: jurastudium-ag-vorbereitung
...
> Opencode-Port von `jurastudium/skills/ag-vorbereitung/SKILL.md`. Urspruenglicher Skill-Name: `ag-vorbereitung`.
...
3. **Lernprofil** (`.opencode/profile/jurastudium.md`) → Fachsemester, Schwächen, Lernstil
