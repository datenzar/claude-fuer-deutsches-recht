---
name: agb-recht-pruefer-saas-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/saas-agb/SKILL.md`. Urspruenglicher Skill-Name: `saas-agb`.

# SaaS AGB

## Wann verwenden

Nutze diesen Skill für **SaaS AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
