---
name: agb-recht-pruefer-datenexport-portabilitaet
...
> Opencode-Port von `agb-recht-pruefer/skills/datenexport-portabilitaet/SKILL.md`. Urspruenglicher Skill-Name: `datenexport-portabilitaet`.

# Datenexport Portabilität

## Wann verwenden

Nutze diesen Skill für **Datenexport Portabilität** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
