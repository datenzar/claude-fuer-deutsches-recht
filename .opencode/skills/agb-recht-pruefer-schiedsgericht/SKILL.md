---
name: agb-recht-pruefer-schiedsgericht
...
> Opencode-Port von `agb-recht-pruefer/skills/schiedsgericht/SKILL.md`. Urspruenglicher Skill-Name: `schiedsgericht`.

# Schiedsgericht

## Wann verwenden

Nutze diesen Skill für **Schiedsgericht** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
