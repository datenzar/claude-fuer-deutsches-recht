---
name: bgb-bt-pruefer-workflow-output-gutachten-klage-brief
...
> Opencode-Port von `bgb-bt-pruefer/skills/workflow-output-gutachten-klage-brief/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-gutachten-klage-brief`.
