---
name: agb-recht-pruefer-telekommunikation-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/telekommunikation-agb/SKILL.md`. Urspruenglicher Skill-Name: `telekommunikation-agb`.

# Telekommunikation AGB

## Wann verwenden

Nutze diesen Skill für **Telekommunikation AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
