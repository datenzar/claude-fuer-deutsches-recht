---
name: agb-recht-pruefer-website-update-check
...
> Opencode-Port von `agb-recht-pruefer/skills/website-update-check/SKILL.md`. Urspruenglicher Skill-Name: `website-update-check`.

# Website Update Check

## Wann verwenden

Nutze diesen Skill für **Website Update Check** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
