---
name: agb-recht-pruefer-product-counsel-workflow
...
> Opencode-Port von `agb-recht-pruefer/skills/product-counsel-workflow/SKILL.md`. Urspruenglicher Skill-Name: `product-counsel-workflow`.

# Product Counsel Workflow

## Wann verwenden

Nutze diesen Skill für **Product Counsel Workflow** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
