---
name: datenschutzrecht-joint-controller-vereinbarung
...
> Opencode-Port von `datenschutzrecht/skills/joint-controller-vereinbarung/SKILL.md`. Urspruenglicher Skill-Name: `joint-controller-vereinbarung`.
