---
name: subsumtions-pruefer-workflow-output-waehlen
...
> Opencode-Port von `subsumtions-pruefer/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
