---
name: robotik-recht-workflow-zweckbestimmung-und-usecase
...
> Opencode-Port von `robotik-recht/skills/workflow-zweckbestimmung-und-usecase/SKILL.md`. Urspruenglicher Skill-Name: `workflow-zweckbestimmung-und-usecase`.
