---
name: agb-recht-pruefer-einkaufsbedingungen-b2b
...
> Opencode-Port von `agb-recht-pruefer/skills/einkaufsbedingungen-b2b/SKILL.md`. Urspruenglicher Skill-Name: `einkaufsbedingungen-b2b`.

# Einkaufsbedingungen B2B

## Wann verwenden

Nutze diesen Skill für **Einkaufsbedingungen B2B** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
