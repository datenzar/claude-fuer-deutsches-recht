---
name: email-umformulierer-berufsrecht-email-eingangsanalyse
...
> Opencode-Port von `email-umformulierer-berufsrecht/skills/email-eingangsanalyse/SKILL.md`. Urspruenglicher Skill-Name: `email-eingangsanalyse`.
