---
name: insolvenzrecht-workflow-output-waehlen
...
> Opencode-Port von `insolvenzrecht/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
