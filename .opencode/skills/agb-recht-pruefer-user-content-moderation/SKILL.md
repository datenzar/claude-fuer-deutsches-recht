---
name: agb-recht-pruefer-user-content-moderation
...
> Opencode-Port von `agb-recht-pruefer/skills/user-content-moderation/SKILL.md`. Urspruenglicher Skill-Name: `user-content-moderation`.

# User Content Moderation

## Wann verwenden

Nutze diesen Skill für **User Content Moderation** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
