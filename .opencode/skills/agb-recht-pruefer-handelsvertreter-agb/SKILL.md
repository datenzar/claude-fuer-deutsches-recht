---
name: agb-recht-pruefer-handelsvertreter-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/handelsvertreter-agb/SKILL.md`. Urspruenglicher Skill-Name: `handelsvertreter-agb`.

# Handelsvertreter AGB

## Wann verwenden

Nutze diesen Skill für **Handelsvertreter AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
