---
name: schriftform-und-textform-bgb-kuendigung-per-schriftsatz-e15a4ae5
...
> Opencode-Port von `schriftform-und-textform-bgb/skills/kuendigung-per-schriftsatz-zustellung-formfragen/SKILL.md`. Urspruenglicher Skill-Name: `kuendigung-per-schriftsatz-zustellung-formfragen`.
