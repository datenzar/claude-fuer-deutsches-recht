---
name: agb-recht-pruefer-auditrechte
...
> Opencode-Port von `agb-recht-pruefer/skills/auditrechte/SKILL.md`. Urspruenglicher Skill-Name: `auditrechte`.

# Auditrechte

## Wann verwenden

Nutze diesen Skill für **Auditrechte** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
