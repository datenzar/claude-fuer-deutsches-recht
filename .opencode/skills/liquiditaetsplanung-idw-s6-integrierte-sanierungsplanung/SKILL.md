---
name: liquiditaetsplanung-idw-s6-integrierte-sanierungsplanung
...
> Opencode-Port von `liquiditaetsplanung/skills/idw-s6-integrierte-sanierungsplanung/SKILL.md`. Urspruenglicher Skill-Name: `idw-s6-integrierte-sanierungsplanung`.
