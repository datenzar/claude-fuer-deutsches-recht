---
name: robotik-recht-workflow-update-und-change-control
...
> Opencode-Port von `robotik-recht/skills/workflow-update-und-change-control/SKILL.md`. Urspruenglicher Skill-Name: `workflow-update-und-change-control`.
