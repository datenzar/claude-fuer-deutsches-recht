---
name: robotik-recht-datensatzqualitaet-und-bias-hri
description: "Prüft Datenqualität und Bias bei Robotern, die Menschen erkennen, unterstützen, bewerten oder priorisieren."
---

> Opencode-Port von `robotik-recht/skills/datensatzqualitaet-und-bias-hri/SKILL.md`. Urspruenglicher Skill-Name: `datensatzqualitaet-und-bias-hri`.

# Datenqualität und Bias HRI
...
Dieser Skill fokussiert: **Prüft Datenqualität und Bias bei Robotern, die Menschen erkennen, unterstützen, bewerten oder priorisieren.**

Quellen-/Normenanker: KI-VO Art. 10; DSGVO; Grundrechte.
