---
name: agb-recht-pruefer-versionsdiff-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/versionsdiff-agb/SKILL.md`. Urspruenglicher Skill-Name: `versionsdiff-agb`.

# Versionsdiff AGB

## Wann verwenden

Nutze diesen Skill für **Versionsdiff AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
