---
name: patentrecherche-workflow-rechtsquellen-livecheck
...
> Opencode-Port von `patentrecherche/skills/workflow-rechtsquellen-livecheck/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsquellen-livecheck`.
