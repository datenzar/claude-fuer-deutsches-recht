---
name: jurastudium-workflow-rechtsquellen-livecheck
...
> Opencode-Port von `jurastudium/skills/workflow-rechtsquellen-livecheck/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsquellen-livecheck`.
