---
name: agb-recht-pruefer-ki-output-nutzung
...
> Opencode-Port von `agb-recht-pruefer/skills/ki-output-nutzung/SKILL.md`. Urspruenglicher Skill-Name: `ki-output-nutzung`.

# KI Output Nutzung

## Wann verwenden

Nutze diesen Skill für **KI Output Nutzung** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
