---
name: verfassungsrecht-workflow-redteam-qualitygate
...
> Opencode-Port von `verfassungsrecht/skills/workflow-redteam-qualitygate/SKILL.md`. Urspruenglicher Skill-Name: `workflow-redteam-qualitygate`.
