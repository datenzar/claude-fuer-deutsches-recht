---
name: wandeldarlehen-lebenszyklus-cap-table-update-pre-post
...
> Opencode-Port von `wandeldarlehen-lebenszyklus/skills/cap-table-update-pre-post/SKILL.md`. Urspruenglicher Skill-Name: `cap-table-update-pre-post`.
