---
name: ecommerce-recht-livecheck-bgb-uwg-ddg-dsa-pangv
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Livecheck BGB UWG DDG DSA PAngV."
---

> Opencode-Port von `ecommerce-recht/skills/livecheck-bgb-uwg-ddg-dsa-pangv/SKILL.md`. Urspruenglicher Skill-Name: `livecheck-bgb-uwg-ddg-dsa-pangv`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Livecheck BGB UWG DDG DSA PAngV..
