---
name: fachanwalt-sozialrecht-mandanten-intake
...
> Opencode-Port von `fachanwalt-sozialrecht/skills/mandanten-intake/SKILL.md`. Urspruenglicher Skill-Name: `mandanten-intake`.
...
- Aktenstruktur nach Plugin-Konvention: `./sozialrecht-kanzlei/mandate/<az>-<name>/`
