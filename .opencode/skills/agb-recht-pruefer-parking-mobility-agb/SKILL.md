---
name: agb-recht-pruefer-parking-mobility-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/parking-mobility-agb/SKILL.md`. Urspruenglicher Skill-Name: `parking-mobility-agb`.

# Parking Mobility AGB

## Wann verwenden

Nutze diesen Skill für **Parking Mobility AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
