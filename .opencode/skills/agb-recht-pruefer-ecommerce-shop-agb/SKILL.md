---
name: agb-recht-pruefer-ecommerce-shop-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/ecommerce-shop-agb/SKILL.md`. Urspruenglicher Skill-Name: `ecommerce-shop-agb`.

# Ecommerce Shop AGB

## Wann verwenden

Nutze diesen Skill für **Ecommerce Shop AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
