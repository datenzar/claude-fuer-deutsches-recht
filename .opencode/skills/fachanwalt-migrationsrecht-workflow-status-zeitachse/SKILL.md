---
name: fachanwalt-migrationsrecht-workflow-status-zeitachse
description: "Status-Zeitachse: Workflow-Skill für Migrationsrecht; rekonstruiert Einreise, Titel, Anträge, Fiktionen, Unterbrechungen und Zuständigkeiten; mit Statusmatrix, Fristenrettung, Staatenbezug, Quellencheck und nutzbarem Output."
---

> Opencode-Port von `fachanwalt-migrationsrecht/skills/workflow-status-zeitachse/SKILL.md`. Urspruenglicher Skill-Name: `workflow-status-zeitachse`.
