...
> Opencode-Port von `steuerrecht-anwalt-und-berater/skills/allgemein/SKILL.md`. Urspruenglicher Skill-Name: `allgemein`.
...
| `stb-ki-tools-im-stb-betrieb-grenzen-berufsrecht` | KI-Tools im StB-Betrieb Berufsrechtliche Grenzen § 57 StBerG. Anwendungsfall ChatGPT opencode Microsoft Copilot Datev-KI Nutzung Mandantenkommunikation Berufsverschwiegenheit. Methodik Prüfung Compliance KI-VO… |
