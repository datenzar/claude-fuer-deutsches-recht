---
name: insolvenzforderungsanmeldungspruefung-workflow-output-waehlen
...
> Opencode-Port von `insolvenzforderungsanmeldungspruefung/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
