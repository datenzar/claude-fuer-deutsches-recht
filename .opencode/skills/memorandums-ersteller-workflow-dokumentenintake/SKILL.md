---
name: memorandums-ersteller-workflow-dokumentenintake
...
> Opencode-Port von `memorandums-ersteller/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
