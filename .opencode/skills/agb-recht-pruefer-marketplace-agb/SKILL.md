---
name: agb-recht-pruefer-marketplace-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/marketplace-agb/SKILL.md`. Urspruenglicher Skill-Name: `marketplace-agb`.

# Marketplace AGB

## Wann verwenden

Nutze diesen Skill für **Marketplace AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
