---
name: insolvenzforderungsanmeldungspruefung-allgemein
...
> Opencode-Port von `insolvenzforderungsanmeldungspruefung/skills/allgemein/SKILL.md`. Urspruenglicher Skill-Name: `allgemein`.
