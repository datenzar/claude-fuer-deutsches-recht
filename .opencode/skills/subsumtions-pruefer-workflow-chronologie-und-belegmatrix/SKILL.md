...
> Opencode-Port von `subsumtions-pruefer/skills/workflow-chronologie-und-belegmatrix/SKILL.md`. Urspruenglicher Skill-Name: `workflow-chronologie-und-belegmatrix`.
