---
name: buerokratieversteher-entbuerokratisierer-pflegegrad-md
description: "Erklärt Pflegegradbescheid, Begutachtung, Module, Pflegetagebuch, Widerspruch und Frist."
---

> Opencode-Port von `buerokratieversteher-entbuerokratisierer/skills/pflegegrad-md/SKILL.md`. Urspruenglicher Skill-Name: `pflegegrad-md`.
