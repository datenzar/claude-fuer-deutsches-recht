---
name: agb-recht-pruefer-rollout-mail-bestandskunden
...
> Opencode-Port von `agb-recht-pruefer/skills/rollout-mail-bestandskunden/SKILL.md`. Urspruenglicher Skill-Name: `rollout-mail-bestandskunden`.

# Rollout Mail Bestandskunden

## Wann verwenden

Nutze diesen Skill für **Rollout Mail Bestandskunden** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
