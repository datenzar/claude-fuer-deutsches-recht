---
name: dsa-dma-digitalregulierung-workflow-fristen-und-risikoampel
...
> Opencode-Port von `dsa-dma-digitalregulierung/skills/workflow-fristen-und-risikoampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fristen-und-risikoampel`.
