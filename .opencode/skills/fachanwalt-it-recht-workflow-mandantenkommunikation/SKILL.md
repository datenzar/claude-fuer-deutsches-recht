---
name: fachanwalt-it-recht-workflow-mandantenkommunikation
...
> Opencode-Port von `fachanwalt-it-recht/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
