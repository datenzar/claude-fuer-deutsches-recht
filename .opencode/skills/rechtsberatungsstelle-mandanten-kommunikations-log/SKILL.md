---
name: rechtsberatungsstelle-mandanten-kommunikations-log
...
> Opencode-Port von `rechtsberatungsstelle/skills/mandanten-kommunikations-log/SKILL.md`. Urspruenglicher Skill-Name: `mandanten-kommunikations-log`.
