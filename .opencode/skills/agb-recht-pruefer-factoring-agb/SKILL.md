---
name: agb-recht-pruefer-factoring-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/factoring-agb/SKILL.md`. Urspruenglicher Skill-Name: `factoring-agb`.

# Factoring AGB

## Wann verwenden

Nutze diesen Skill für **Factoring AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
