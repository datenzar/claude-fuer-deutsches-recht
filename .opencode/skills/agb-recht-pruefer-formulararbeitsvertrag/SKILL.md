---
name: agb-recht-pruefer-formulararbeitsvertrag
...
> Opencode-Port von `agb-recht-pruefer/skills/formulararbeitsvertrag/SKILL.md`. Urspruenglicher Skill-Name: `formulararbeitsvertrag`.

# Formulararbeitsvertrag

## Wann verwenden

Nutze diesen Skill für **Formulararbeitsvertrag** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
