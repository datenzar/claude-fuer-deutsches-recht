---
name: agb-recht-pruefer-versicherung-avb
...
> Opencode-Port von `agb-recht-pruefer/skills/versicherung-avb/SKILL.md`. Urspruenglicher Skill-Name: `versicherung-avb`.

# Versicherung Avb

## Wann verwenden

Nutze diesen Skill für **Versicherung Avb** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
