---
name: fachanwalt-familienrecht-fehlerhafte-auskunft-versorgungstraeger
...
> Opencode-Port von `fachanwalt-familienrecht/skills/fehlerhafte-auskunft-versorgungstraeger/SKILL.md`. Urspruenglicher Skill-Name: `fehlerhafte-auskunft-versorgungstraeger`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Fehlerhafte Auskunft Versorgungsträger: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
