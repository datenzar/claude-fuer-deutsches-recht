---
name: agb-recht-pruefer-verkaufsbedingungen-b2b
...
> Opencode-Port von `agb-recht-pruefer/skills/verkaufsbedingungen-b2b/SKILL.md`. Urspruenglicher Skill-Name: `verkaufsbedingungen-b2b`.

# Verkaufsbedingungen B2B

## Wann verwenden

Nutze diesen Skill für **Verkaufsbedingungen B2B** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
