---
name: prozessrecht-workflow-dokumentenintake
...
> Opencode-Port von `prozessrecht/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
