---
name: robotik-recht-workflow-sachverstaendigenbriefing
...
> Opencode-Port von `robotik-recht/skills/workflow-sachverstaendigenbriefing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-sachverstaendigenbriefing`.
