---
name: nda-abgleich-nda-typen-vergleich
...
> Opencode-Port von `nda-abgleich/skills/nda-typen-vergleich/SKILL.md`. Urspruenglicher Skill-Name: `nda-typen-vergleich`.

# NDA-Typen Vergleich

## Aufgabe
NDA-Typen vergleichen: einseitig (unilateral), gegenseitig (mutual), mehrparteiig.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `nda-abgleich` zum Thema `nda-typen-vergleich`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: NDA-Typen vergleichen: einseitig (unilateral), gegenseitig (mutual), mehrparteiig. Empfehlung pro Situation: Verkaeufer in M&A unilateral; gemeinsame Entwicklung mutual; Konsortium mehrparteiig. Praxisanker fuer Templates..
