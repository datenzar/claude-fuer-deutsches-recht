---
name: agb-recht-pruefer-crypto-exchange-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/crypto-exchange-agb/SKILL.md`. Urspruenglicher Skill-Name: `crypto-exchange-agb`.

# Crypto Exchange AGB

## Wann verwenden

Nutze diesen Skill für **Crypto Exchange AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
