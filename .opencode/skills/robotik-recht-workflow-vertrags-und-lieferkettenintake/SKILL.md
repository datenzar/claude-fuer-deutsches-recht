---
name: robotik-recht-workflow-vertrags-und-lieferkettenintake
...
> Opencode-Port von `robotik-recht/skills/workflow-vertrags-und-lieferkettenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-vertrags-und-lieferkettenintake`.
