---
name: agb-recht-pruefer-feedback-rechte
...
> Opencode-Port von `agb-recht-pruefer/skills/feedback-rechte/SKILL.md`. Urspruenglicher Skill-Name: `feedback-rechte`.

# Feedback Rechte

## Wann verwenden

Nutze diesen Skill für **Feedback Rechte** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
