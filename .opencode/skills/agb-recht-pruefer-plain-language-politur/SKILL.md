---
name: agb-recht-pruefer-plain-language-politur
...
> Opencode-Port von `agb-recht-pruefer/skills/plain-language-politur/SKILL.md`. Urspruenglicher Skill-Name: `plain-language-politur`.

# Plain Language Politur

## Wann verwenden

Nutze diesen Skill für **Plain Language Politur** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
