---
name: agb-recht-pruefer-einstweilige-verfuegung-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/einstweilige-verfuegung-agb/SKILL.md`. Urspruenglicher Skill-Name: `einstweilige-verfuegung-agb`.

# Einstweilige Verfügung AGB

## Wann verwenden

Nutze diesen Skill für **Einstweilige Verfügung AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
