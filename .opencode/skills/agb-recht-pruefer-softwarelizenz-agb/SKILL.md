---
name: agb-recht-pruefer-softwarelizenz-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/softwarelizenz-agb/SKILL.md`. Urspruenglicher Skill-Name: `softwarelizenz-agb`.

# Softwarelizenz AGB

## Wann verwenden

Nutze diesen Skill für **Softwarelizenz AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
