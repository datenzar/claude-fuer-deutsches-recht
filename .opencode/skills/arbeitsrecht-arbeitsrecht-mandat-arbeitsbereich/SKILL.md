---
name: arbeitsrecht-arbeitsrecht-mandat-arbeitsbereich
...
> Opencode-Port von `arbeitsrecht/skills/arbeitsrecht-mandat-arbeitsbereich/SKILL.md`. Urspruenglicher Skill-Name: `arbeitsrecht-mandat-arbeitsbereich`.
...
- `.opencode/profile/arbeitsrecht.md` – Abschnitt `## Mandantenakten`

## Ablauf

### Vorabprüfung

`.opencode/profile/arbeitsrecht.md` lesen, Abschnitt `## Mandantenakten` prüfen.
