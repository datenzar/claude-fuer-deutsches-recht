---
name: rechtsberatungsstelle-workflow-dokumentenintake
...
> Opencode-Port von `rechtsberatungsstelle/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
