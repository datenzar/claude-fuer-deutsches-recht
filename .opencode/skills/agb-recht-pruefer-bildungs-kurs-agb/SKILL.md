---
name: agb-recht-pruefer-bildungs-kurs-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/bildungs-kurs-agb/SKILL.md`. Urspruenglicher Skill-Name: `bildungs-kurs-agb`.

# Bildungs Kurs AGB

## Wann verwenden

Nutze diesen Skill für **Bildungs Kurs AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
