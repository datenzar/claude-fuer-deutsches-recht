---
name: ecommerce-recht-dokumentenintake-screenshots-agb-logs
...
> Opencode-Port von `ecommerce-recht/skills/dokumentenintake-screenshots-agb-logs/SKILL.md`. Urspruenglicher Skill-Name: `dokumentenintake-screenshots-agb-logs`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Dokumentenintake Screenshots AGB Logs..
