---
name: kanzlei-builder-hub-workflow-mandantenkommunikation
...
> Opencode-Port von `kanzlei-builder-hub/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
