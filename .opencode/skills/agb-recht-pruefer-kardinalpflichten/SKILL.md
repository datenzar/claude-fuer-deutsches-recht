---
name: agb-recht-pruefer-kardinalpflichten
...
> Opencode-Port von `agb-recht-pruefer/skills/kardinalpflichten/SKILL.md`. Urspruenglicher Skill-Name: `kardinalpflichten`.

# Kardinalpflichten

## Wann verwenden

Nutze diesen Skill für **Kardinalpflichten** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
