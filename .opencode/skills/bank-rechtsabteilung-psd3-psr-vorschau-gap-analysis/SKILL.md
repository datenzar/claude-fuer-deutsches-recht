---
name: bank-rechtsabteilung-psd3-psr-vorschau-gap-analysis
...
> Opencode-Port von `bank-rechtsabteilung/skills/psd3-psr-vorschau-gap-analysis/SKILL.md`. Urspruenglicher Skill-Name: `psd3-psr-vorschau-gap-analysis`.
