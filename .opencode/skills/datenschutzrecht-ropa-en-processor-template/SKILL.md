---
name: datenschutzrecht-ropa-en-processor-template
...
> Opencode-Port von `datenschutzrecht/skills/ropa-en-processor-template/SKILL.md`. Urspruenglicher Skill-Name: `ropa-en-processor-template`.
