---
name: agb-recht-pruefer-risk-acceptance-memo
...
> Opencode-Port von `agb-recht-pruefer/skills/risk-acceptance-memo/SKILL.md`. Urspruenglicher Skill-Name: `risk-acceptance-memo`.

# Risk Acceptance Memo

## Wann verwenden

Nutze diesen Skill für **Risk Acceptance Memo** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
