---
name: subsumtions-pruefer-workflow-dokumentenintake
...
> Opencode-Port von `subsumtions-pruefer/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
