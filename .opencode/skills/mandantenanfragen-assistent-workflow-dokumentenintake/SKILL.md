---
name: mandantenanfragen-assistent-workflow-dokumentenintake
...
> Opencode-Port von `mandantenanfragen-assistent/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
