---
name: kanzlei-builder-hub-kanzlei-builder-hub-anpassen
...
> Opencode-Port von `kanzlei-builder-hub/skills/kanzlei-builder-hub-anpassen/SKILL.md`. Urspruenglicher Skill-Name: `kanzlei-builder-hub-anpassen`.
...
- Aktuelles Kanzleiprofil: `.opencode/profile/kanzlei-builder-hub.md`
- Geteiltes Kanzleiprofil: `./kanzlei-profil.md`
...
Änderung in `./kanzlei-builder-hub/customization-log.md` protokollieren:
