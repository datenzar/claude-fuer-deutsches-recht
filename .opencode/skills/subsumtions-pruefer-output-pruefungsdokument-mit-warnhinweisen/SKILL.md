---
name: subsumtions-pruefer-output-pruefungsdokument-mit-warnhinweisen
...
> Opencode-Port von `subsumtions-pruefer/skills/output-pruefungsdokument-mit-warnhinweisen/SKILL.md`. Urspruenglicher Skill-Name: `output-pruefungsdokument-mit-warnhinweisen`.
