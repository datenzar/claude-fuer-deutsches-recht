---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-scree-1fb6440e
description: "Vertiefter Skill fuer Screening Tool Validierung. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-screening-tool-validierung/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-screening-tool-validierung`.

# Screening Tool Validierung

## Zweck

Dieser Skill behandelt **Screening Tool Validierung** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
