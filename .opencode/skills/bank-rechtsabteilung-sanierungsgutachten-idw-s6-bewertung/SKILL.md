---
name: bank-rechtsabteilung-sanierungsgutachten-idw-s6-bewertung
...
> Opencode-Port von `bank-rechtsabteilung/skills/sanierungsgutachten-idw-s6-bewertung/SKILL.md`. Urspruenglicher Skill-Name: `sanierungsgutachten-idw-s6-bewertung`.
