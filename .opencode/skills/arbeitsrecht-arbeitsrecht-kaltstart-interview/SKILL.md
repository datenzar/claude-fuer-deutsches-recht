---
name: arbeitsrecht-arbeitsrecht-kaltstart-interview
...
> Opencode-Port von `arbeitsrecht/skills/arbeitsrecht-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `arbeitsrecht-kaltstart-interview`.
...
- Konfigurationsdatei `.opencode/profile/arbeitsrecht.md` (Zieldatei)
...
1. `.opencode/profile/arbeitsrecht.md` prüfen.
...
Alle gesammelten Informationen in `.opencode/profile/arbeitsrecht.md` schreiben. Übergeordnete Verzeichnisse anlegen. Company-profile.md erstellen, falls nicht vorhanden.
...
Konfiguration gespeichert: .opencode/profile/arbeitsrecht.md
```
