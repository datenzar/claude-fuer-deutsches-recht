---
name: datenschutzrecht-joint-controllership-en-template
...
> Opencode-Port von `datenschutzrecht/skills/joint-controllership-en-template/SKILL.md`. Urspruenglicher Skill-Name: `joint-controllership-en-template`.
