---
name: insolvenzverwaltung-iv-plan-datenraum-register
...
> Opencode-Port von `insolvenzverwaltung/skills/iv-plan-datenraum-register/SKILL.md`. Urspruenglicher Skill-Name: `iv-plan-datenraum-register`.
