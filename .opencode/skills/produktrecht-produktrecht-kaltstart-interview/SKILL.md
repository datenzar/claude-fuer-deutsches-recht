---
name: produktrecht-produktrecht-kaltstart-interview
...
> Opencode-Port von `produktrecht/skills/produktrecht-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `produktrecht-kaltstart-interview`.

# /kaltstart-interview

1. Zustand von `.opencode/profile/produktrecht.md` prüfen.
...
6. `.opencode/profile/produktrecht.md` schreiben (übergeordnete Verzeichnisse bei Bedarf erstellen). Kalibrierungstabelle zur Bestätigung zeigen.
...
`.opencode/profile/produktrecht.md` lesen:
...
Nach `./unternehmens-profil.md` suchen.
