---
name: agb-recht-pruefer-verhandlungs-playbook-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/verhandlungs-playbook-agb/SKILL.md`. Urspruenglicher Skill-Name: `verhandlungs-playbook-agb`.

# Verhandlungs Playbook AGB

## Wann verwenden

Nutze diesen Skill für **Verhandlungs Playbook AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
