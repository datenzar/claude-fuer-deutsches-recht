---
name: kanzlei-builder-hub-skills-qualitaetspruefung
...
> Opencode-Port von `kanzlei-builder-hub/skills/skills-qualitaetspruefung/SKILL.md`. Urspruenglicher Skill-Name: `skills-qualitaetspruefung`.
...
- Zugehörige `CLAUDE.md` (Template im Plugin-Verzeichnis, Nutzerkonfiguration unter `.opencode/plugins/config/kanzlei-builder-hub/<plugin>/CLAUDE.md`) — welches Kanzleiprofil der Skill liest und benötigt
