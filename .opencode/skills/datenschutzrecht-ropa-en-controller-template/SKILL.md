---
name: datenschutzrecht-ropa-en-controller-template
...
> Opencode-Port von `datenschutzrecht/skills/ropa-en-controller-template/SKILL.md`. Urspruenglicher Skill-Name: `ropa-en-controller-template`.
