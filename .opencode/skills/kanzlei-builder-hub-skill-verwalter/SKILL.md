---
name: kanzlei-builder-hub-skill-verwalter
...
> Opencode-Port von `kanzlei-builder-hub/skills/skill-verwalter/SKILL.md`. Urspruenglicher Skill-Name: `skill-verwalter`.
...
Installationspfad aus dem Protokoll bestimmen (bei der Installation eingetragen). Alle Dateien und Unterverzeichnisse auflisten. Auch alle Konfigurationsdateien identifizieren, die der Skill in das Nutzerverzeichnis `.opencode/plugins/config/...` geschrieben hat — dem Nutzer anzeigen, aber standardmäßig **nicht** löschen (Konfiguration kann für eine spätere Neuinstallation wertvoll sein).
...
2. Installationspfad: `.opencode/skills/vertragsanalyse-nda/`; 7 Dateien.
