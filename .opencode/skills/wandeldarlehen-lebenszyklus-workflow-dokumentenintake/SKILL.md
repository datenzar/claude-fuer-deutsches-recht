---
name: wandeldarlehen-lebenszyklus-workflow-dokumentenintake
...
> Opencode-Port von `wandeldarlehen-lebenszyklus/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
