---
name: word-legal-ai-plugin-and-skill-for-german-lawyers-partn-ddcc11ab
description: "Setzt knappe Partnerkommentare und Randnotizen in echte Drafting-Schritte um. Übersetzt Hinweise wie bitte schärfen, zu lang, commercial, mehr Druck, weniger Gutachten, US counsel fragt, in eine Änderungsliste, priorisiert die Arbeit und formuliert die betroffenen Passagen neu."
---

> Opencode-Port von `word-legal-ai-plugin-and-skill-for-german-lawyers/skills/partner-kommentar-umsetzen/SKILL.md`. Urspruenglicher Skill-Name: `partner-kommentar-umsetzen`.
