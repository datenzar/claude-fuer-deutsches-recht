---
name: agb-recht-pruefer-leasing-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/leasing-agb/SKILL.md`. Urspruenglicher Skill-Name: `leasing-agb`.

# Leasing AGB

## Wann verwenden

Nutze diesen Skill für **Leasing AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
