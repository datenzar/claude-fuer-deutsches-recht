---
name: kanzlei-builder-hub-deaktivieren
...
> Opencode-Port von `kanzlei-builder-hub/skills/deaktivieren/SKILL.md`. Urspruenglicher Skill-Name: `deaktivieren`.
...
- Installationsprotokoll: `./kanzlei-builder-hub/installations-protokoll.yaml`
...
Zu deaktivierende Dateien (Umbenennung, keine Löschung):
  .opencode/skills/[skill-name]/SKILL.md
    → SKILL.md.disabled
  .opencode/skills/[skill-name]/ausloeser/ausloeser.json (falls vorhanden)
    → ausloeser.json.disabled

Konfiguration bleibt erhalten:
  .opencode/plugins/config/.../[skill-name]/ (wird NICHT angefasst)
...
Zu deaktivierende Dateien (Umbenennung, keine Löschung):
  .opencode/skills/nda-prüfung/SKILL.md
    → SKILL.md.disabled

Konfiguration bleibt erhalten:
  .opencode/plugins/config/.../nda-prüfung/ (wird NICHT angefasst)
