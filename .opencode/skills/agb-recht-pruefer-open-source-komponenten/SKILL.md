---
name: agb-recht-pruefer-open-source-komponenten
...
> Opencode-Port von `agb-recht-pruefer/skills/open-source-komponenten/SKILL.md`. Urspruenglicher Skill-Name: `open-source-komponenten`.

# Open Source Komponenten

## Wann verwenden

Nutze diesen Skill für **Open Source Komponenten** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
