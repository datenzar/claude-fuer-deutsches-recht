---
name: arbeitszeugnis-analyse-zeugnis-problem-sortieren
...
> Opencode-Port von `arbeitszeugnis-analyse/skills/zeugnis-problem-sortieren/SKILL.md`. Urspruenglicher Skill-Name: `zeugnis-problem-sortieren`.
