---
name: robotik-recht-workflow-security-by-design-sprint
...
> Opencode-Port von `robotik-recht/skills/workflow-security-by-design-sprint/SKILL.md`. Urspruenglicher Skill-Name: `workflow-security-by-design-sprint`.
