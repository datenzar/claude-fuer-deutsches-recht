---
name: krankenhausrecht-klinikakten-und-bescheide-sortieren
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Klinikakten und Bescheide sortieren."
---

> Opencode-Port von `krankenhausrecht/skills/klinikakten-und-bescheide-sortieren/SKILL.md`. Urspruenglicher Skill-Name: `klinikakten-und-bescheide-sortieren`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Klinikakten und Bescheide sortieren..
