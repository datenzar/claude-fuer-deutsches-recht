---
name: agb-recht-pruefer-compliance-sanktionen
...
> Opencode-Port von `agb-recht-pruefer/skills/compliance-sanktionen/SKILL.md`. Urspruenglicher Skill-Name: `compliance-sanktionen`.

# Compliance Sanktionen

## Wann verwenden

Nutze diesen Skill für **Compliance Sanktionen** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
