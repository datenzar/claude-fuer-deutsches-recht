---
name: ki-governance-workflow-redteam-qualitygate
...
> Opencode-Port von `ki-governance/skills/workflow-redteam-qualitygate/SKILL.md`. Urspruenglicher Skill-Name: `workflow-redteam-qualitygate`.
