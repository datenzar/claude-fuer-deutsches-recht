---
name: liquiditaetsplanung-workflow-redteam-qualitygate
...
> Opencode-Port von `liquiditaetsplanung/skills/workflow-redteam-qualitygate/SKILL.md`. Urspruenglicher Skill-Name: `workflow-redteam-qualitygate`.
