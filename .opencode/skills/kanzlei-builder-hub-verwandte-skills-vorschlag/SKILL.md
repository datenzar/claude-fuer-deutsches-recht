---
name: kanzlei-builder-hub-verwandte-skills-vorschlag
...
> Opencode-Port von `kanzlei-builder-hub/skills/verwandte-skills-vorschlag/SKILL.md`. Urspruenglicher Skill-Name: `verwandte-skills-vorschlag`.
...
- Kanzleiprofil: `.opencode/profile/kanzlei-builder-hub.md` → Praxisprofil, installierte Skills (bereits installierte nicht vorschlagen), Benachrichtigungseinstellungen
...
Gemäß `.opencode/profile/kanzlei-builder-hub.md` → neue Skill-Benachrichtigungen:
