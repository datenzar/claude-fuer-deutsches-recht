---
name: patentrecht-rechtsstand-register-und-fristen
...
> Opencode-Port von `patentrecht/skills/rechtsstand-register-und-fristen/SKILL.md`. Urspruenglicher Skill-Name: `rechtsstand-register-und-fristen`.
