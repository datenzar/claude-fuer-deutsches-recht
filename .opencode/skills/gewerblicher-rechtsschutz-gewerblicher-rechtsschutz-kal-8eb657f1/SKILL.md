---
name: gewerblicher-rechtsschutz-gewerblicher-rechtsschutz-kal-8eb657f1
...
> Opencode-Port von `gewerblicher-rechtsschutz/skills/gewerblicher-rechtsschutz-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `gewerblicher-rechtsschutz-kaltstart-interview`.
...
`.opencode/profile/gewerblicher-rechtsschutz.md`
...
Falls `./unternehmens-profil.md` nicht existiert oder Platzhalter enthält, zunächst diese fünf Fragen stellen:
