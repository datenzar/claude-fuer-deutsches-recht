---
name: strafzumessung-workflow-dokumentenintake
...
> Opencode-Port von `strafzumessung/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
