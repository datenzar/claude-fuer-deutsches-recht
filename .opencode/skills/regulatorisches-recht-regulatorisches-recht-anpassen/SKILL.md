---
name: regulatorisches-recht-regulatorisches-recht-anpassen
...
> Opencode-Port von `regulatorisches-recht/skills/regulatorisches-recht-anpassen/SKILL.md`. Urspruenglicher Skill-Name: `regulatorisches-recht-anpassen`.
...
Praxisprofil aus `.opencode/profile/regulatorisches-recht.md` lesen. Falls `[PLATZHALTER]`-Marker vorhanden: zum `regulatorisches-recht-kaltstart-interview` umleiten.
...
>
> Gespeichert in `.opencode/profile/regulatorisches-recht.md` [Geändert am 01.06.2025]
>
