---
name: fachanwalt-familienrecht-rentnerfall-beide-beziehen-rente
...
> Opencode-Port von `fachanwalt-familienrecht/skills/rentnerfall-beide-beziehen-rente/SKILL.md`. Urspruenglicher Skill-Name: `rentnerfall-beide-beziehen-rente`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Rentnerfall beide beziehen Rente: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
