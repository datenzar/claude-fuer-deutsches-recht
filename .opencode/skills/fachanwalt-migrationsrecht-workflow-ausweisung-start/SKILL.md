---
name: fachanwalt-migrationsrecht-workflow-ausweisung-start
description: "Ausweisung Start: Workflow-Skill für Migrationsrecht; prüft Ausweisungsinteresse, Bleibeinteresse, Verhältnismäßigkeit und EMRK; mit Statusmatrix, Fristenrettung, Staatenbezug, Quellencheck und nutzbarem Output."
---

> Opencode-Port von `fachanwalt-migrationsrecht/skills/workflow-ausweisung-start/SKILL.md`. Urspruenglicher Skill-Name: `workflow-ausweisung-start`.
