---
name: verlagsredaktion-barrierefreiheit-epub-pdf
...
> Opencode-Port von `verlagsredaktion/skills/barrierefreiheit-epub-pdf/SKILL.md`. Urspruenglicher Skill-Name: `barrierefreiheit-epub-pdf`.
