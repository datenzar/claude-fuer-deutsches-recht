---
name: fachanwalt-familienrecht-excel-pruefmatrix-anrechte
...
> Opencode-Port von `fachanwalt-familienrecht/skills/excel-pruefmatrix-anrechte/SKILL.md`. Urspruenglicher Skill-Name: `excel-pruefmatrix-anrechte`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Excel-Prüfmatrix Anrechte: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
