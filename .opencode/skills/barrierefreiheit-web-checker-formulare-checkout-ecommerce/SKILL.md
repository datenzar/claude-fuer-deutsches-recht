---
name: barrierefreiheit-web-checker-formulare-checkout-ecommerce
...
> Opencode-Port von `barrierefreiheit-web-checker/skills/formulare-checkout-ecommerce/SKILL.md`. Urspruenglicher Skill-Name: `formulare-checkout-ecommerce`.
