---
name: europarecht-kompass-workflow-fristen-und-risikoampel
...
> Opencode-Port von `europarecht-kompass/skills/workflow-fristen-und-risikoampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fristen-und-risikoampel`.
