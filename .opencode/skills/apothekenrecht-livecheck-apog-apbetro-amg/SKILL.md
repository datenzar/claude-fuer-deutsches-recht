---
name: apothekenrecht-livecheck-apog-apbetro-amg
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Livecheck ApoG ApBetrO AMG."
---

> Opencode-Port von `apothekenrecht/skills/livecheck-apog-apbetro-amg/SKILL.md`. Urspruenglicher Skill-Name: `livecheck-apog-apbetro-amg`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Livecheck ApoG ApBetrO AMG..
