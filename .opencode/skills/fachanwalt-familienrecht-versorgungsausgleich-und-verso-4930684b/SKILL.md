---
name: fachanwalt-familienrecht-versorgungsausgleich-und-verso-4930684b
...
> Opencode-Port von `fachanwalt-familienrecht/skills/versorgungsausgleich-und-versorgungsausgleichskasse/SKILL.md`. Urspruenglicher Skill-Name: `versorgungsausgleich-und-versorgungsausgleichskasse`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Versorgungsausgleich und Versorgungsausgleichskasse: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: VersAusglG, FamFG Scheidungsverbund und Beschwerde, SGB VI, Beamtenversorgung, BetrAVG, Versorgungsträgerauskünfte..
