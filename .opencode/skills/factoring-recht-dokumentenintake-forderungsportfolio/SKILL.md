---
name: factoring-recht-dokumentenintake-forderungsportfolio
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Dokumentenintake Forderungsportfolio."
---

> Opencode-Port von `factoring-recht/skills/dokumentenintake-forderungsportfolio/SKILL.md`. Urspruenglicher Skill-Name: `dokumentenintake-forderungsportfolio`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Dokumentenintake Forderungsportfolio..
