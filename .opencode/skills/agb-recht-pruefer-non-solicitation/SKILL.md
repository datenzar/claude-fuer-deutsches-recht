---
name: agb-recht-pruefer-non-solicitation
...
> Opencode-Port von `agb-recht-pruefer/skills/non-solicitation/SKILL.md`. Urspruenglicher Skill-Name: `non-solicitation`.

# Non Solicitation

## Wann verwenden

Nutze diesen Skill für **Non Solicitation** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
