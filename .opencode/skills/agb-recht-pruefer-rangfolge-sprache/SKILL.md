---
name: agb-recht-pruefer-rangfolge-sprache
...
> Opencode-Port von `agb-recht-pruefer/skills/rangfolge-sprache/SKILL.md`. Urspruenglicher Skill-Name: `rangfolge-sprache`.

# Rangfolge Sprache

## Wann verwenden

Nutze diesen Skill für **Rangfolge Sprache** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
