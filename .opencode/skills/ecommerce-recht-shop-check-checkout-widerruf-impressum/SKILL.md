---
name: ecommerce-recht-shop-check-checkout-widerruf-impressum
...
> Opencode-Port von `ecommerce-recht/skills/shop-check-checkout-widerruf-impressum/SKILL.md`. Urspruenglicher Skill-Name: `shop-check-checkout-widerruf-impressum`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Shop Check Checkout Widerruf Impressum..
