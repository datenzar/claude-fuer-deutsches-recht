---
name: rechtsberatungsstelle-recherche-start
...
> Opencode-Port von `rechtsberatungsstelle/skills/recherche-start/SKILL.md`. Urspruenglicher Skill-Name: `recherche-start`.
