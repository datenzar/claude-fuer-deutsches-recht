---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-post-2c703d94
description: "Vertiefter Skill fuer Post Merger Icp Integration. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-post-merger-icp-integration/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-post-merger-icp-integration`.

# Post Merger Icp Integration

## Zweck

Dieser Skill behandelt **Post Merger Icp Integration** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
