---
name: tabellenreview-3d-workflow-output-waehlen
...
> Opencode-Port von `tabellenreview-3d/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
