---
name: patentrecherche-workflow-redteam-qualitygate
...
> Opencode-Port von `patentrecherche/skills/workflow-redteam-qualitygate/SKILL.md`. Urspruenglicher Skill-Name: `workflow-redteam-qualitygate`.
