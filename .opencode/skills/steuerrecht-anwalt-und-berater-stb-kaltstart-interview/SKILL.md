---
name: steuerrecht-anwalt-und-berater-stb-kaltstart-interview
...
> Opencode-Port von `steuerrecht-anwalt-und-berater/skills/stb-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `stb-kaltstart-interview`.
...
1. Zustand der Konfigurationsdatei `.opencode/profile/steuerrecht-anwalt-und-berater.md` prüfen.
...
Das Praxisprofil wird in `.opencode/profile/steuerrecht-anwalt-und-berater.md` geschrieben. Anschließend zeigen:
