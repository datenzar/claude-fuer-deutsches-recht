---
name: gesellschaftsgruender-workflow-kaltstart-und-routing
...
> Opencode-Port von `gesellschaftsgruender/skills/workflow-kaltstart-und-routing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-kaltstart-und-routing`.
