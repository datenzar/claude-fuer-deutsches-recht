---
name: agb-recht-pruefer-lagerbedingungen
...
> Opencode-Port von `agb-recht-pruefer/skills/lagerbedingungen/SKILL.md`. Urspruenglicher Skill-Name: `lagerbedingungen`.

# Lagerbedingungen

## Wann verwenden

Nutze diesen Skill für **Lagerbedingungen** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
