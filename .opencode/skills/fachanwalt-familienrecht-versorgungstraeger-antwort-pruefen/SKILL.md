---
name: fachanwalt-familienrecht-versorgungstraeger-antwort-pruefen
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Versorgungsträger Antwort prüfen."
---

> Opencode-Port von `fachanwalt-familienrecht/skills/versorgungstraeger-antwort-pruefen/SKILL.md`. Urspruenglicher Skill-Name: `versorgungstraeger-antwort-pruefen`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Versorgungsträger Antwort prüfen..
