---
name: fachanwalt-sozialrecht-akteneinsicht-auswerten
...
> Opencode-Port von `fachanwalt-sozialrecht/skills/akteneinsicht-auswerten/SKILL.md`. Urspruenglicher Skill-Name: `akteneinsicht-auswerten`.
...
Verwaltungs- und Sozialakten enthalten besonders sensible Daten (Gesundheit Sozialleistungen Vermögen). Verarbeitung nur in Tools mit AVV. Mandantenakte unter `./sozialrecht-kanzlei/mandate/<az>/` ablegen.
