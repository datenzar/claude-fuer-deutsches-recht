---
name: vertragsrecht-vertragsrecht-mandat-arbeitsbereich
...
> Opencode-Port von `vertragsrecht/skills/vertragsrecht-mandat-arbeitsbereich/SKILL.md`. Urspruenglicher Skill-Name: `vertragsrecht-mandat-arbeitsbereich`.
...
Lies `.opencode/plugins/config/klotzkette/vertragsrecht/CLAUDE.md`. Prüfe
...
```
.opencode/plugins/config/klotzkette/vertragsrecht/
