---
name: insolvenzrecht-insolvenzrecht-kaltstart-interview
description: "Kaltstart-Interview für das Insolvenzrecht-Plugin. Befüllt das Praxisprofil unter .opencode/profile/insolvenzrecht.md mit Angaben zur Rolle (Insolvenzverwalter / Sachwalter / beratender Anwalt / Geschäftsleiter / Sanierungsberater / Wirtschaftsprüfer), typischen Verfahrensarten (Regelinsolvenz / Eigenverwaltung / Schutzschirm / StaRUG / Konzerninsolvenz), bevorzugten Gutachten-Standards (IDW S 6 / S 9 / S 11) und Eskalationsstrukturen. Lädt bei Erstinstallation oder wenn die Konfiguration noch [PLATZHALTER]-Marker enthält. Mit --redo für ein erneutes Interview, mit --integrationen-prüfen nur für eine Konnektoren-Prüfung."
---

> Opencode-Port von `insolvenzrecht/skills/insolvenzrecht-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `insolvenzrecht-kaltstart-interview`.

# /insolvenzrecht:insolvenzrecht-kaltstart-interview

## Ablauf

1. Zustand der Konfigurationsdatei `.opencode/profile/insolvenzrecht.md` prüfen.
...
Das Praxisprofil wird in `.opencode/profile/insolvenzrecht.md` geschrieben. Anschließend zeigen:
