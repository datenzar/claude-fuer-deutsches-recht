---
name: produktrecht-produktbeobachtung-software-ota
...
> Opencode-Port von `produktrecht/skills/produktbeobachtung-software-ota/SKILL.md`. Urspruenglicher Skill-Name: `produktbeobachtung-software-ota`.
