---
name: ki-governance-spezial-use-case-risk-classification
...
> Opencode-Port von `ki-governance/skills/spezial-use-case-risk-classification/SKILL.md`. Urspruenglicher Skill-Name: `spezial-use-case-risk-classification`.
