---
name: patentrecherche-workflow-output-waehlen
...
> Opencode-Port von `patentrecherche/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
