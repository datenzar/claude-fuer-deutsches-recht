---
name: agb-recht-pruefer-haendlervertrag-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/haendlervertrag-agb/SKILL.md`. Urspruenglicher Skill-Name: `haendlervertrag-agb`.

# Haendlervertrag AGB

## Wann verwenden

Nutze diesen Skill für **Haendlervertrag AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
