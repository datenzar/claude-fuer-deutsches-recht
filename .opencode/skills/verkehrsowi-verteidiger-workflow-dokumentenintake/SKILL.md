---
name: verkehrsowi-verteidiger-workflow-dokumentenintake
...
> Opencode-Port von `verkehrsowi-verteidiger/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
