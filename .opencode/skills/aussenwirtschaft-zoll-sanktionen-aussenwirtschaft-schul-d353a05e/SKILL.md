---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-schul-d353a05e
description: "Vertiefter Skill fuer Schulung Exportkontrolle Rollout. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-schulung-exportkontrolle-rollout/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-schulung-exportkontrolle-rollout`.

# Schulung Exportkontrolle Rollout

## Zweck

Dieser Skill behandelt **Schulung Exportkontrolle Rollout** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
