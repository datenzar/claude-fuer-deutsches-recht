---
name: agb-recht-pruefer-backup-datenverlust
...
> Opencode-Port von `agb-recht-pruefer/skills/backup-datenverlust/SKILL.md`. Urspruenglicher Skill-Name: `backup-datenverlust`.

# Backup Datenverlust

## Wann verwenden

Nutze diesen Skill für **Backup Datenverlust** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
