---
name: fachanwalt-sozialrecht-bescheid-frist-quick-check
...
> Opencode-Port von `fachanwalt-sozialrecht/skills/bescheid-frist-quick-check/SKILL.md`. Urspruenglicher Skill-Name: `bescheid-frist-quick-check`.
