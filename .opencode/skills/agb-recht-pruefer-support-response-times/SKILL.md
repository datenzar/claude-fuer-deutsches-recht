---
name: agb-recht-pruefer-support-response-times
...
> Opencode-Port von `agb-recht-pruefer/skills/support-response-times/SKILL.md`. Urspruenglicher Skill-Name: `support-response-times`.

# Support Response Times

## Wann verwenden

Nutze diesen Skill für **Support Response Times** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
