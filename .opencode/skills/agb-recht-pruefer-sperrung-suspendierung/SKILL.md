---
name: agb-recht-pruefer-sperrung-suspendierung
...
> Opencode-Port von `agb-recht-pruefer/skills/sperrung-suspendierung/SKILL.md`. Urspruenglicher Skill-Name: `sperrung-suspendierung`.

# Sperrung Suspendierung

## Wann verwenden

Nutze diesen Skill für **Sperrung Suspendierung** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
