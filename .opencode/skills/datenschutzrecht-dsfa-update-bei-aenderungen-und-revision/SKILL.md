---
name: datenschutzrecht-dsfa-update-bei-aenderungen-und-revision
...
> Opencode-Port von `datenschutzrecht/skills/dsfa-update-bei-aenderungen-und-revision/SKILL.md`. Urspruenglicher Skill-Name: `dsfa-update-bei-aenderungen-und-revision`.
