---
name: agb-recht-pruefer-negative-feststellung-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/negative-feststellung-agb/SKILL.md`. Urspruenglicher Skill-Name: `negative-feststellung-agb`.

# Negative Feststellung AGB

## Wann verwenden

Nutze diesen Skill für **Negative Feststellung AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
