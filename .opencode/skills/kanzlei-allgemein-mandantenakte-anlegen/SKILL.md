---
name: kanzlei-allgemein-mandantenakte-anlegen
...
> Opencode-Port von `kanzlei-allgemein/skills/mandantenakte-anlegen/SKILL.md`. Urspruenglicher Skill-Name: `mandantenakte-anlegen`.
...
Unter `./kanzlei-allgemein/mandate/<az>/`:
...
In `./kanzlei-allgemein/mandantenstamm.yaml`:
