---
name: schriftform-und-textform-bgb-workflow-dokumentenintake
...
> Opencode-Port von `schriftform-und-textform-bgb/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
