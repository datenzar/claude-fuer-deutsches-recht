---
name: agb-recht-pruefer-abtretung
...
> Opencode-Port von `agb-recht-pruefer/skills/abtretung/SKILL.md`. Urspruenglicher Skill-Name: `abtretung`.

# Abtretung

## Wann verwenden

Nutze diesen Skill für **Abtretung** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
