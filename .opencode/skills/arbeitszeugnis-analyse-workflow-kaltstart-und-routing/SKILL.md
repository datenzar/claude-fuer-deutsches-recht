---
name: arbeitszeugnis-analyse-workflow-kaltstart-und-routing
...
> Opencode-Port von `arbeitszeugnis-analyse/skills/workflow-kaltstart-und-routing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-kaltstart-und-routing`.
