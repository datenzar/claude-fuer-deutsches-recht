---
name: bank-rechtsabteilung-travel-rule-krypto-transfers
...
> Opencode-Port von `bank-rechtsabteilung/skills/travel-rule-krypto-transfers/SKILL.md`. Urspruenglicher Skill-Name: `travel-rule-krypto-transfers`.
