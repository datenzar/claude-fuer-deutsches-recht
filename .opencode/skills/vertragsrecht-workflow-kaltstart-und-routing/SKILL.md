---
name: vertragsrecht-workflow-kaltstart-und-routing
...
> Opencode-Port von `vertragsrecht/skills/workflow-kaltstart-und-routing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-kaltstart-und-routing`.
