---
name: zitierweise-deutsches-recht-workflow-output-waehlen
...
> Opencode-Port von `zitierweise-deutsches-recht/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
