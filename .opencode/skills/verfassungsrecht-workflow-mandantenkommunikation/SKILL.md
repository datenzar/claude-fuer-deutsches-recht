---
name: verfassungsrecht-workflow-mandantenkommunikation
...
> Opencode-Port von `verfassungsrecht/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
