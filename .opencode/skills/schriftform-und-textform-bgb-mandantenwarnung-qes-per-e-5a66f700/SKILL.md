---
name: schriftform-und-textform-bgb-mandantenwarnung-qes-per-e-5a66f700
...
> Opencode-Port von `schriftform-und-textform-bgb/skills/mandantenwarnung-qes-per-email-whatsapp-und-zugang/SKILL.md`. Urspruenglicher Skill-Name: `mandantenwarnung-qes-per-email-whatsapp-und-zugang`.
