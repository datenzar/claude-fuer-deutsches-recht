---
name: bank-rechtsabteilung-outsourcing-crypto-dlt-node-provider
...
> Opencode-Port von `bank-rechtsabteilung/skills/outsourcing-crypto-dlt-node-provider/SKILL.md`. Urspruenglicher Skill-Name: `outsourcing-crypto-dlt-node-provider`.
