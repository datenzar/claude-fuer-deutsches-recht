---
name: kanzlei-builder-hub-workflow-output-waehlen
...
> Opencode-Port von `kanzlei-builder-hub/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
