---
name: agb-recht-pruefer-vdug-abhilfeklage-agb-schnittstelle
...
> Opencode-Port von `agb-recht-pruefer/skills/vdug-abhilfeklage-agb-schnittstelle/SKILL.md`. Urspruenglicher Skill-Name: `vdug-abhilfeklage-agb-schnittstelle`.

# VDuG Abhilfeklage AGB Schnittstelle

## Wann verwenden

Nutze diesen Skill für **VDuG Abhilfeklage AGB Schnittstelle** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
