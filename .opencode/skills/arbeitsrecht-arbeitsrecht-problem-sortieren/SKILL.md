---
name: arbeitsrecht-arbeitsrecht-problem-sortieren
...
> Opencode-Port von `arbeitsrecht/skills/arbeitsrecht-problem-sortieren/SKILL.md`. Urspruenglicher Skill-Name: `arbeitsrecht-problem-sortieren`.
