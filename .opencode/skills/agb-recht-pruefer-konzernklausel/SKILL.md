---
name: agb-recht-pruefer-konzernklausel
...
> Opencode-Port von `agb-recht-pruefer/skills/konzernklausel/SKILL.md`. Urspruenglicher Skill-Name: `konzernklausel`.

# Konzernklausel

## Wann verwenden

Nutze diesen Skill für **Konzernklausel** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
