---
name: agb-recht-pruefer-reseller-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/reseller-agb/SKILL.md`. Urspruenglicher Skill-Name: `reseller-agb`.

# Reseller AGB

## Wann verwenden

Nutze diesen Skill für **Reseller AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
