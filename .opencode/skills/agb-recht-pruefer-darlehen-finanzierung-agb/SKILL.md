---
name: agb-recht-pruefer-darlehen-finanzierung-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/darlehen-finanzierung-agb/SKILL.md`. Urspruenglicher Skill-Name: `darlehen-finanzierung-agb`.

# Darlehen Finanzierung AGB

## Wann verwenden

Nutze diesen Skill für **Darlehen Finanzierung AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
