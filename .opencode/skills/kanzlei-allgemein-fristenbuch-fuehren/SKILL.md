---
name: kanzlei-allgemein-fristenbuch-fuehren
...
> Opencode-Port von `kanzlei-allgemein/skills/fristenbuch-fuehren/SKILL.md`. Urspruenglicher Skill-Name: `fristenbuch-fuehren`.
...
`./kanzlei-allgemein/fristenbuch.yaml`
