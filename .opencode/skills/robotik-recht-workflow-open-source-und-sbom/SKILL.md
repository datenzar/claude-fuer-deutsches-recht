---
name: robotik-recht-workflow-open-source-und-sbom
description: "Sammelt FOSS, SBOM, Lizenzen, Security Advisories, Maintainer-Risiken und regulatorische Verantwortungsfragen."
---

> Opencode-Port von `robotik-recht/skills/workflow-open-source-und-sbom/SKILL.md`. Urspruenglicher Skill-Name: `workflow-open-source-und-sbom`.
