---
name: fortbestehensprognose-bilanzieller-status-aufnehmen
...
> Opencode-Port von `fortbestehensprognose/skills/bilanzieller-status-aufnehmen/SKILL.md`. Urspruenglicher Skill-Name: `bilanzieller-status-aufnehmen`.
