---
name: jurastudium-jurastudium-kaltstart-interview
...
> Opencode-Port von `jurastudium/skills/jurastudium-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `jurastudium-kaltstart-interview`.
...
Dieser Skill ist der **einmalige Einrichtungsschritt**, der alle anderen Skills erst brauchbar macht. Er stellt die Fragen, die nötig sind, um dein Lernprofil unter `.opencode/profile/jurastudium.md` sinnvoll zu befüllen.
...
Das Plugin schreibt alle Angaben in `.opencode/profile/jurastudium.md` und meldet:
