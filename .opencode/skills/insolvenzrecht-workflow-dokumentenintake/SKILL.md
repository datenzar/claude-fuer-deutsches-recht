---
name: insolvenzrecht-workflow-dokumentenintake
...
> Opencode-Port von `insolvenzrecht/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
