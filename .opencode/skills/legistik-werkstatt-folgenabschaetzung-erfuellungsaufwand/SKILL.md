...
> Opencode-Port von `legistik-werkstatt/skills/folgenabschaetzung-erfuellungsaufwand/SKILL.md`. Urspruenglicher Skill-Name: `folgenabschaetzung-erfuellungsaufwand`.
