---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-antid-ba0173b1
description: "Vertiefter Skill fuer Antidumping TARIC Massnahmen. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-antidumping-taric-massnahmen/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-antidumping-taric-massnahmen`.

# Antidumping TARIC Massnahmen

## Zweck

Dieser Skill behandelt **Antidumping TARIC Massnahmen** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
