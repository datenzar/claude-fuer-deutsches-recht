---
name: prozessrecht-workflow-rechtsquellen-livecheck
...
> Opencode-Port von `prozessrecht/skills/workflow-rechtsquellen-livecheck/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsquellen-livecheck`.
