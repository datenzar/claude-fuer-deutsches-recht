---
name: agb-recht-pruefer-change-request
...
> Opencode-Port von `agb-recht-pruefer/skills/change-request/SKILL.md`. Urspruenglicher Skill-Name: `change-request`.

# Change Reqüst

## Wann verwenden

Nutze diesen Skill für **Change Reqüst** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
