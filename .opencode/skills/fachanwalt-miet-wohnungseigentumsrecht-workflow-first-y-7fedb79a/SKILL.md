---
name: fachanwalt-miet-wohnungseigentumsrecht-workflow-first-y-7fedb79a
description: "First-Year-Associate-Coach Mietrecht: Workflow-Skill für Miet- und WEG-Recht; führt neue Anwältinnen durch Anspruchsaufbau, Fristen, Belege und Schriftsatzlogik; mit Kaltstart, Fristencheck, Belegmatrix, Anschluss-Skills und nutzbarem Output."
---

> Opencode-Port von `fachanwalt-miet-wohnungseigentumsrecht/skills/workflow-first-year-associate-mietrecht/SKILL.md`. Urspruenglicher Skill-Name: `workflow-first-year-associate-mietrecht`.
