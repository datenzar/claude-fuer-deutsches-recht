---
name: dsa-dma-digitalregulierung-workflow-output-waehlen
...
> Opencode-Port von `dsa-dma-digitalregulierung/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
