---
name: insolvenzrecht-workflow-fristen-und-risikoampel
...
> Opencode-Port von `insolvenzrecht/skills/workflow-fristen-und-risikoampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fristen-und-risikoampel`.
