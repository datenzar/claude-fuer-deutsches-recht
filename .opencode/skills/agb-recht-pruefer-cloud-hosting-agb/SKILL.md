---
name: agb-recht-pruefer-cloud-hosting-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/cloud-hosting-agb/SKILL.md`. Urspruenglicher Skill-Name: `cloud-hosting-agb`.

# Cloud Hosting AGB

## Wann verwenden

Nutze diesen Skill für **Cloud Hosting AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
