---
name: agb-recht-pruefer-klausel-entwerfen-balanced
...
> Opencode-Port von `agb-recht-pruefer/skills/klausel-entwerfen-balanced/SKILL.md`. Urspruenglicher Skill-Name: `klausel-entwerfen-balanced`.

# Klausel Entwerfen Balanced

## Wann verwenden

Nutze diesen Skill für **Klausel Entwerfen Balanced** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
