---
name: verkehrsowi-verteidiger-verkehrsowi-simulation-training
...
> Opencode-Port von `verkehrsowi-verteidiger/skills/verkehrsowi-simulation-training/SKILL.md`. Urspruenglicher Skill-Name: `verkehrsowi-simulation-training`.
