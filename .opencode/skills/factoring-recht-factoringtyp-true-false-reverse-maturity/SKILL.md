---
name: factoring-recht-factoringtyp-true-false-reverse-maturity
...
> Opencode-Port von `factoring-recht/skills/factoringtyp-true-false-reverse-maturity/SKILL.md`. Urspruenglicher Skill-Name: `factoringtyp-true-false-reverse-maturity`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Factoringtyp true false reverse maturity..
