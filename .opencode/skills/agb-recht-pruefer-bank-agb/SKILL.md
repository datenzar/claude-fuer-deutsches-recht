---
name: agb-recht-pruefer-bank-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/bank-agb/SKILL.md`. Urspruenglicher Skill-Name: `bank-agb`.

# Bank AGB

## Wann verwenden

Nutze diesen Skill für **Bank AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
