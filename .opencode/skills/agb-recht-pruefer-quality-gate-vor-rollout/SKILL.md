---
name: agb-recht-pruefer-quality-gate-vor-rollout
...
> Opencode-Port von `agb-recht-pruefer/skills/quality-gate-vor-rollout/SKILL.md`. Urspruenglicher Skill-Name: `quality-gate-vor-rollout`.

# Quality Gate Vor Rollout

## Wann verwenden

Nutze diesen Skill für **Quality Gate Vor Rollout** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
