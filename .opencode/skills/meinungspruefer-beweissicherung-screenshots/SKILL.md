---
name: meinungspruefer-beweissicherung-screenshots
...
> Opencode-Port von `meinungspruefer/skills/beweissicherung-screenshots/SKILL.md`. Urspruenglicher Skill-Name: `beweissicherung-screenshots`.
