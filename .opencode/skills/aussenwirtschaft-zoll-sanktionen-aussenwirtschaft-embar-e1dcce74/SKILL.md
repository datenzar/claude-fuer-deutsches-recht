---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-embar-e1dcce74
description: "Vertiefter Skill fuer Belarus-Embargo mit Sanktionslisten, Gueterverboten, Transport- und Finanzierungsfragen. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-embargo-belarus/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-embargo-belarus`.

# Embargo Belarus

## Zweck

Dieser Skill behandelt **Belarus-Embargo mit Sanktionslisten, Gueterverboten, Transport- und Finanzierungsfragen** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
