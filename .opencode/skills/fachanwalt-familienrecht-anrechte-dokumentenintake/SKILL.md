---
name: fachanwalt-familienrecht-anrechte-dokumentenintake
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Anrechte Dokumentenintake."
---

> Opencode-Port von `fachanwalt-familienrecht/skills/anrechte-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `anrechte-dokumentenintake`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Anrechte Dokumentenintake..
