---
name: kanzlei-builder-hub-automatischer-aktualisierer
...
> Opencode-Port von `kanzlei-builder-hub/skills/automatischer-aktualisierer/SKILL.md`. Urspruenglicher Skill-Name: `automatischer-aktualisierer`.
...
- Laufende Konfiguration: `.opencode/profile/kanzlei-builder-hub.md` → installierte Skills (mit Versionsnummer/Commit-SHA), Update-Einstellungen (benachrichtigen / manuell).
...
Installierte Skill-Dateien durch neue Version ersetzen. `.opencode/profile/kanzlei-builder-hub.md` mit neuem Commit-SHA aktualisieren. Alte Version vorher sichern (nach `.opencode/skills/.backups/[skill]-[alter-sha]/`) für Rollback.
