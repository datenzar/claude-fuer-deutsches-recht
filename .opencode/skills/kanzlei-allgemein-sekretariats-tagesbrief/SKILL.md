---
name: kanzlei-allgemein-sekretariats-tagesbrief
...
> Opencode-Port von `kanzlei-allgemein/skills/sekretariats-tagesbrief/SKILL.md`. Urspruenglicher Skill-Name: `sekretariats-tagesbrief`.
...
- Tagesbrief-Archiv unter `./kanzlei-allgemein/tagesbriefe/`.
