---
name: corporate-kanzlei-corporate-kanzlei-vertragsmarkup-key-issues
...
> Opencode-Port von `corporate-kanzlei/skills/corporate-kanzlei-vertragsmarkup-key-issues/SKILL.md`. Urspruenglicher Skill-Name: `corporate-kanzlei-vertragsmarkup-key-issues`.
