---
name: prozessrecht-workflow-fristen-und-risikoampel
...
> Opencode-Port von `prozessrecht/skills/workflow-fristen-und-risikoampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-fristen-und-risikoampel`.
