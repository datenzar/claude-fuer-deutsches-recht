---
name: agb-recht-pruefer-legal-note-redline-output
...
> Opencode-Port von `agb-recht-pruefer/skills/legal-note-redline-output/SKILL.md`. Urspruenglicher Skill-Name: `legal-note-redline-output`.

# Legal Note Redline Output

## Wann verwenden

Nutze diesen Skill für **Legal Note Redline Output** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
