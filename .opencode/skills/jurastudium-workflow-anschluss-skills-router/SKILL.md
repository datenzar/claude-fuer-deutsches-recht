---
name: jurastudium-workflow-anschluss-skills-router
...
> Opencode-Port von `jurastudium/skills/workflow-anschluss-skills-router/SKILL.md`. Urspruenglicher Skill-Name: `workflow-anschluss-skills-router`.
