---
name: kanzlei-builder-hub-kanzlei-builder-hub-kaltstart-interview
...
> Opencode-Port von `kanzlei-builder-hub/skills/kanzlei-builder-hub-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `kanzlei-builder-hub-kaltstart-interview`.
...
`.opencode/profile/kanzlei-builder-hub.md` lesen:
...
Prüfen ob `./kanzlei-profil.md` existiert:
...
Abschließen mit:
> Fertig. Ihre Konfiguration liegt unter `.opencode/profile/kanzlei-builder-hub.md` — eine Klartextdatei, die Sie direkt lesen und bearbeiten können. Alles kann geändert werden:
>
