---
name: robotik-recht-workflow-rechtsregime-matrix
...
> Opencode-Port von `robotik-recht/skills/workflow-rechtsregime-matrix/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsregime-matrix`.
