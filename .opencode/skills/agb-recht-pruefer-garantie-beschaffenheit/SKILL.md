---
name: agb-recht-pruefer-garantie-beschaffenheit
...
> Opencode-Port von `agb-recht-pruefer/skills/garantie-beschaffenheit/SKILL.md`. Urspruenglicher Skill-Name: `garantie-beschaffenheit`.

# Garantie Beschaffenheit

## Wann verwenden

Nutze diesen Skill für **Garantie Beschaffenheit** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
