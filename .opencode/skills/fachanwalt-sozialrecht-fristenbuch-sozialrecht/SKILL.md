---
name: fachanwalt-sozialrecht-fristenbuch-sozialrecht
...
> Opencode-Port von `fachanwalt-sozialrecht/skills/fristenbuch-sozialrecht/SKILL.md`. Urspruenglicher Skill-Name: `fristenbuch-sozialrecht`.

# Fristenbuch Sozialrecht

## Zentralablage

`./sozialrecht-kanzlei/fristenbuch.yaml`
