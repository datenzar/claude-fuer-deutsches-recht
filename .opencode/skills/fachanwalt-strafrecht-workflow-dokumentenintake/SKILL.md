---
name: fachanwalt-strafrecht-workflow-dokumentenintake
...
> Opencode-Port von `fachanwalt-strafrecht/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
