---
name: bank-rechtsabteilung-staking-lending-token-bank
...
> Opencode-Port von `bank-rechtsabteilung/skills/staking-lending-token-bank/SKILL.md`. Urspruenglicher Skill-Name: `staking-lending-token-bank`.
