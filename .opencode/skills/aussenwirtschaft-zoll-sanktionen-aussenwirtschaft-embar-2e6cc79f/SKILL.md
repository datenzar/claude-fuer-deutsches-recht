---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-embar-2e6cc79f
description: "Vertiefter Skill fuer Embargo Myanmar. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-embargo-myanmar/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-embargo-myanmar`.

# Embargo Myanmar

## Zweck

Dieser Skill behandelt **Embargo Myanmar** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
