---
name: legistik-werkstatt-normenkontrollrat-kmu-check
...
> Opencode-Port von `legistik-werkstatt/skills/normenkontrollrat-kmu-check/SKILL.md`. Urspruenglicher Skill-Name: `normenkontrollrat-kmu-check`.
