---
name: robotik-recht-workflow-kaltstart-und-routing
...
> Opencode-Port von `robotik-recht/skills/workflow-kaltstart-und-routing/SKILL.md`. Urspruenglicher Skill-Name: `workflow-kaltstart-und-routing`.
