---
name: rechtsberatungsstelle-mandantenbrief
...
> Opencode-Port von `rechtsberatungsstelle/skills/mandantenbrief/SKILL.md`. Urspruenglicher Skill-Name: `mandantenbrief`.
