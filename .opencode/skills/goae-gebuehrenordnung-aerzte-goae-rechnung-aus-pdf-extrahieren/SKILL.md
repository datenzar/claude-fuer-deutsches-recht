---
name: goae-gebuehrenordnung-aerzte-goae-rechnung-aus-pdf-extrahieren
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema GOÄ Rechnung aus PDF extrahieren."
---

> Opencode-Port von `goae-gebuehrenordnung-aerzte/skills/goae-rechnung-aus-pdf-extrahieren/SKILL.md`. Urspruenglicher Skill-Name: `goae-rechnung-aus-pdf-extrahieren`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema GOÄ Rechnung aus PDF extrahieren..
