---
name: datenschutzrecht-workflow-output-waehlen
...
> Opencode-Port von `datenschutzrecht/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
