---
name: agb-recht-pruefer-fragebogen-agb-automation
...
> Opencode-Port von `agb-recht-pruefer/skills/fragebogen-agb-automation/SKILL.md`. Urspruenglicher Skill-Name: `fragebogen-agb-automation`.

# Fragebogen AGB Automation

## Wann verwenden

Nutze diesen Skill für **Fragebogen AGB Automation** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
