---
name: vertragsrecht-vertragsverlaengerungs-monitor
...
> Opencode-Port von `vertragsrecht/skills/vertragsverlaengerungs-monitor/SKILL.md`. Urspruenglicher Skill-Name: `vertragsverlaengerungs-monitor`.
...
- Register `./vertragsrecht/renewal-register.yaml`
...
`./vertragsrecht/renewal-register.yaml` lesen. Falls leer und CLM verbunden: Modus 3 (Erst-Import aus CLM) anbieten.
...
Gespeichert unter `./vertragsrecht/renewal-register.yaml`. Jeder Eintrag:
