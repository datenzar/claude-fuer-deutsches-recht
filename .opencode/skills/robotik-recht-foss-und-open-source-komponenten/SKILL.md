---
name: robotik-recht-foss-und-open-source-komponenten
...
> Opencode-Port von `robotik-recht/skills/foss-und-open-source-komponenten/SKILL.md`. Urspruenglicher Skill-Name: `foss-und-open-source-komponenten`.
