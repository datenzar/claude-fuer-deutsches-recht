---
name: robotik-recht-workflow-gutachten-memo-output
...
> Opencode-Port von `robotik-recht/skills/workflow-gutachten-memo-output/SKILL.md`. Urspruenglicher Skill-Name: `workflow-gutachten-memo-output`.
