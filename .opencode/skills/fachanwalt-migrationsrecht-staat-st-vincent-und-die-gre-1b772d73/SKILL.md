---
name: fachanwalt-migrationsrecht-staat-st-vincent-und-die-gre-1b772d73
description: "Staaten- und Gebietscheck St. Vincent und die Grenadinen: migrationsrechtlicher Workflow für Herkunfts-, Transit-, Dokumenten-, Visum-, Schutz-, Passbeschaffungs-, Rückführungs- und Aufenthaltstitelfragen mit Live-Quellencheck und optionaler spanischer Erklärung."
---

> Opencode-Port von `fachanwalt-migrationsrecht/skills/staat-st-vincent-und-die-grenadinen-migrationscheck/SKILL.md`. Urspruenglicher Skill-Name: `staat-st-vincent-und-die-grenadinen-migrationscheck`.
