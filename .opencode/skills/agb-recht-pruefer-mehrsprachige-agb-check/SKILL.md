---
name: agb-recht-pruefer-mehrsprachige-agb-check
...
> Opencode-Port von `agb-recht-pruefer/skills/mehrsprachige-agb-check/SKILL.md`. Urspruenglicher Skill-Name: `mehrsprachige-agb-check`.

# Mehrsprachige AGB Check

## Wann verwenden

Nutze diesen Skill für **Mehrsprachige AGB Check** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
