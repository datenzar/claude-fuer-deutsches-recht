---
name: factoring-recht-output-vertragsentwurf-memo-anzeige
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Output Vertragsentwurf Memo Anzeige."
---

> Opencode-Port von `factoring-recht/skills/output-vertragsentwurf-memo-anzeige/SKILL.md`. Urspruenglicher Skill-Name: `output-vertragsentwurf-memo-anzeige`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Output Vertragsentwurf Memo Anzeige..
