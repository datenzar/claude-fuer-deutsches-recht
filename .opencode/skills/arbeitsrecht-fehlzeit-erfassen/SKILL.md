---
name: arbeitsrecht-fehlzeit-erfassen
...
> Opencode-Port von `arbeitsrecht/skills/fehlzeit-erfassen/SKILL.md`. Urspruenglicher Skill-Name: `fehlzeit-erfassen`.

# /arbeitsrecht:fehlzeit-erfassen

## Zweck

Neue Abwesenheit in `./arbeitsrecht/urlaubsregister.yaml` eintragen, sodass der Urlaub-/Fehlzeiten-Tracker alle Fristen ab Tag 1 überwacht.

## Eingaben

- Mitarbeiter-Angaben (Name/ID – anonymisiert genügt)
- Abwesenheitstyp und Startdatum
- `.opencode/profile/arbeitsrecht.md` → Standort, Tarifvertrag
...
Register-Eintrag anlegen in `./arbeitsrecht/urlaubsregister.yaml`:
