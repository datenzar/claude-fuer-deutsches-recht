---
name: agb-recht-pruefer-ip-nutzungsrechte
...
> Opencode-Port von `agb-recht-pruefer/skills/ip-nutzungsrechte/SKILL.md`. Urspruenglicher Skill-Name: `ip-nutzungsrechte`.

# IP Nutzungsrechte

## Wann verwenden

Nutze diesen Skill für **IP Nutzungsrechte** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
