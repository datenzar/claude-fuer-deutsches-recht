---
name: agb-recht-pruefer-agb-versionierung-aenderungshistorie
...
> Opencode-Port von `agb-recht-pruefer/skills/agb-versionierung-aenderungshistorie/SKILL.md`. Urspruenglicher Skill-Name: `agb-versionierung-aenderungshistorie`.

# AGB Versionierung Änderungshistorie

## Wann verwenden

Nutze diesen Skill für **AGB Versionierung Änderungshistorie** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
