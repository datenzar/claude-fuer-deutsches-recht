---
name: ki-governance-ki-governance-mandat-arbeitsbereich
...
> Opencode-Port von `ki-governance/skills/ki-governance-mandat-arbeitsbereich/SKILL.md`. Urspruenglicher Skill-Name: `ki-governance-mandat-arbeitsbereich`.
...
- Praxisprofil aus `.opencode/profile/ki-governance.md`
...
- `/ki-governance:ki-governance-mandat-arbeitsbereich close <slug>` – Mandat archivieren (nach
  `./ki-governance/mandate/_archiv/` verschieben, nie löschen)
