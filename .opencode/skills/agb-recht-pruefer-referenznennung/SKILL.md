---
name: agb-recht-pruefer-referenznennung
...
> Opencode-Port von `agb-recht-pruefer/skills/referenznennung/SKILL.md`. Urspruenglicher Skill-Name: `referenznennung`.

# Referenznennung

## Wann verwenden

Nutze diesen Skill für **Referenznennung** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
