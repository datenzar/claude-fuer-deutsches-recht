---
name: agb-recht-pruefer-adversarial-test-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/adversarial-test-agb/SKILL.md`. Urspruenglicher Skill-Name: `adversarial-test-agb`.

# Adversarial Test AGB

## Wann verwenden

Nutze diesen Skill für **Adversarial Test AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
