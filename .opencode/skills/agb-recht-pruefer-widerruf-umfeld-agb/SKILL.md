---
name: agb-recht-pruefer-widerruf-umfeld-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/widerruf-umfeld-agb/SKILL.md`. Urspruenglicher Skill-Name: `widerruf-umfeld-agb`.

# Widerruf Umfeld AGB

## Wann verwenden

Nutze diesen Skill für **Widerruf Umfeld AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
