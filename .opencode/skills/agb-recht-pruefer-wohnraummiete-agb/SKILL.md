---
name: agb-recht-pruefer-wohnraummiete-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/wohnraummiete-agb/SKILL.md`. Urspruenglicher Skill-Name: `wohnraummiete-agb`.

# Wohnraummiete AGB

## Wann verwenden

Nutze diesen Skill für **Wohnraummiete AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
