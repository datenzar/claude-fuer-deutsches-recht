---
name: arbeitsrecht-einstellungspruefung
...
> Opencode-Port von `arbeitsrecht/skills/einstellungspruefung/SKILL.md`. Urspruenglicher Skill-Name: `einstellungspruefung`.
