---
name: agb-recht-pruefer-consulting-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/consulting-agb/SKILL.md`. Urspruenglicher Skill-Name: `consulting-agb`.

# Consulting AGB

## Wann verwenden

Nutze diesen Skill für **Consulting AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
