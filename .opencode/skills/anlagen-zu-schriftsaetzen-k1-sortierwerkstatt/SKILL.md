---
name: anlagen-zu-schriftsaetzen-k1-sortierwerkstatt
...
> Opencode-Port von `anlagen-zu-schriftsaetzen/skills/k1-sortierwerkstatt/SKILL.md`. Urspruenglicher Skill-Name: `k1-sortierwerkstatt`.
