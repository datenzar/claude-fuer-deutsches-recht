---
name: tabellenreview-3d-tabellenreview-3d-kaltstart-interview
...
> Opencode-Port von `tabellenreview-3d/skills/tabellenreview-3d-kaltstart-interview/SKILL.md`. Urspruenglicher Skill-Name: `tabellenreview-3d-kaltstart-interview`.
...
1. Zustand der Konfigurationsdatei `.opencode/profile/tabellenreview-3d.md` prüfen.
...
- **Excel-Ausgabe-Verzeichnis:** [PLATZHALTER — z. B. `./tabellenreview-3d/würfel/<projekt>/`]
...
Das Praxisprofil wird in `.opencode/profile/tabellenreview-3d.md` geschrieben. Anschließend zeigen:
