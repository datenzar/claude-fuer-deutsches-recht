---
name: parteienrecht-parteiorganisation-social-media-partei
description: "Regelt Impressum, Verantwortlichkeit, Accounts, Kandidatenposts, Datenschutz, Archivierung und Krisenreaktion."
---

> Opencode-Port von `parteienrecht-parteiorganisation/skills/social-media-partei/SKILL.md`. Urspruenglicher Skill-Name: `social-media-partei`.
