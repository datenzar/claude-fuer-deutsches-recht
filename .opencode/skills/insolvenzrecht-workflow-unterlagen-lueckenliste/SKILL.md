---
name: insolvenzrecht-workflow-unterlagen-lueckenliste
...
> Opencode-Port von `insolvenzrecht/skills/workflow-unterlagen-lueckenliste/SKILL.md`. Urspruenglicher Skill-Name: `workflow-unterlagen-lueckenliste`.
