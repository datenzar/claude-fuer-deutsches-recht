---
name: agb-recht-pruefer-rechtsfolge-306-kein-blue-pencil
...
> Opencode-Port von `agb-recht-pruefer/skills/rechtsfolge-306-kein-blue-pencil/SKILL.md`. Urspruenglicher Skill-Name: `rechtsfolge-306-kein-blue-pencil`.

# Rechtsfolge 306 Kein Blü Pencil

## Wann verwenden

Nutze diesen Skill für **Rechtsfolge 306 Kein Blü Pencil** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
