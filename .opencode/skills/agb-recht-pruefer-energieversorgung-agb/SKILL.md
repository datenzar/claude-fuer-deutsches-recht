---
name: agb-recht-pruefer-energieversorgung-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/energieversorgung-agb/SKILL.md`. Urspruenglicher Skill-Name: `energieversorgung-agb`.

# Energieversorgung AGB

## Wann verwenden

Nutze diesen Skill für **Energieversorgung AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
