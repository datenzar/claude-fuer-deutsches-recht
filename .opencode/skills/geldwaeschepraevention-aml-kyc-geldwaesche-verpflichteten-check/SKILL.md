---
name: geldwaeschepraevention-aml-kyc-geldwaesche-verpflichteten-check
...
> Opencode-Port von `geldwaeschepraevention-aml-kyc/skills/geldwaesche-verpflichteten-check/SKILL.md`. Urspruenglicher Skill-Name: `geldwaesche-verpflichteten-check`.
