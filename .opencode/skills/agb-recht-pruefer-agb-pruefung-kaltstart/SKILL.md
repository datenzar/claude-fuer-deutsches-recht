---
name: agb-recht-pruefer-agb-pruefung-kaltstart
...
> Opencode-Port von `agb-recht-pruefer/skills/agb-pruefung-kaltstart/SKILL.md`. Urspruenglicher Skill-Name: `agb-pruefung-kaltstart`.

# AGB Prüfung Kaltstart

## Wann verwenden

Nutze diesen Skill für **AGB Prüfung Kaltstart** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
