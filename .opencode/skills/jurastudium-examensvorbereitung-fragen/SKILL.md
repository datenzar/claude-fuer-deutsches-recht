---
name: jurastudium-examensvorbereitung-fragen
...
> Opencode-Port von `jurastudium/skills/examensvorbereitung-fragen/SKILL.md`. Urspruenglicher Skill-Name: `examensvorbereitung-fragen`.
...
1. Lernprofil unter `.opencode/profile/jurastudium.md` → Bundesland, JAG, Schwächefächer, Lernstil
