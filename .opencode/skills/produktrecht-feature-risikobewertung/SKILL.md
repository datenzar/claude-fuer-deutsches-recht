---
name: produktrecht-feature-risikobewertung
...
> Opencode-Port von `produktrecht/skills/feature-risikobewertung/SKILL.md`. Urspruenglicher Skill-Name: `feature-risikobewertung`.
...
Vor der Fertigstellung gegen `.opencode/profile/produktrecht.md` → Risikokalibrierung prüfen:
...
Eigenständiges Dokument, 2–4 Seiten. Arbeitsvermerk aus `.opencode/profile/produktrecht.md` `## Ausgaben` voranstellen.

Kein Foliensatz, kein Memo zur Akte – ein Entscheidungsdokument das jemand liest und dann entscheidet.

Speichern wo `.opencode/profile/produktrecht.md` → Launch-Review-Prozess sagt wohin Review-Dokumente gehen.
