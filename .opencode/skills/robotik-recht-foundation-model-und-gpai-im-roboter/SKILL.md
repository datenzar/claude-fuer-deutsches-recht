---
name: robotik-recht-foundation-model-und-gpai-im-roboter
...
> Opencode-Port von `robotik-recht/skills/foundation-model-und-gpai-im-roboter/SKILL.md`. Urspruenglicher Skill-Name: `foundation-model-und-gpai-im-roboter`.
