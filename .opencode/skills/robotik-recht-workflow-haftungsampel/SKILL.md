---
name: robotik-recht-workflow-haftungsampel
...
> Opencode-Port von `robotik-recht/skills/workflow-haftungsampel/SKILL.md`. Urspruenglicher Skill-Name: `workflow-haftungsampel`.
