---
name: commercial-courts-deutschland-mediation-settlement-window
...
> Opencode-Port von `commercial-courts-deutschland/skills/mediation-settlement-window/SKILL.md`. Urspruenglicher Skill-Name: `mediation-settlement-window`.
