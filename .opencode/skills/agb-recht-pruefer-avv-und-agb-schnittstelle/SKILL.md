---
name: agb-recht-pruefer-avv-und-agb-schnittstelle
...
> Opencode-Port von `agb-recht-pruefer/skills/avv-und-agb-schnittstelle/SKILL.md`. Urspruenglicher Skill-Name: `avv-und-agb-schnittstelle`.

# AVV und AGB Schnittstelle

## Wann verwenden

Nutze diesen Skill für **AVV und AGB Schnittstelle** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
