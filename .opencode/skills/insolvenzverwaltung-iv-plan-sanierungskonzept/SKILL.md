---
name: insolvenzverwaltung-iv-plan-sanierungskonzept
...
> Opencode-Port von `insolvenzverwaltung/skills/iv-plan-sanierungskonzept/SKILL.md`. Urspruenglicher Skill-Name: `iv-plan-sanierungskonzept`.
