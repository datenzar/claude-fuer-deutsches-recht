---
name: urteilsbauer-relationsmacher-beweiswuerdigung-mit-richter-input
...
> Opencode-Port von `urteilsbauer-relationsmacher/skills/beweiswuerdigung-mit-richter-input/SKILL.md`. Urspruenglicher Skill-Name: `beweiswuerdigung-mit-richter-input`.
