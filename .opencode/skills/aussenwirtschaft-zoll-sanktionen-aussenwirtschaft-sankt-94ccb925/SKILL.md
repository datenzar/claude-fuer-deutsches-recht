---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-sankt-94ccb925
description: "Vertiefter Skill fuer Sanktionsscreening mit Fuzzy Matches, wirtschaftlich Berechtigten und Freigabeprotokoll. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-sanktionsscreening-fuzzy-match/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-sanktionsscreening-fuzzy-match`.

# Sanktionsscreening Fuzzy Match

## Zweck

Dieser Skill behandelt **Sanktionsscreening mit Fuzzy Matches, wirtschaftlich Berechtigten und Freigabeprotokoll** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
