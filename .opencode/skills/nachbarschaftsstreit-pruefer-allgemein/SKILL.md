---
name: nachbarschaftsstreit-pruefer-allgemein
...
> Opencode-Port von `nachbarschaftsstreit-pruefer/skills/allgemein/SKILL.md`. Urspruenglicher Skill-Name: `allgemein`.
