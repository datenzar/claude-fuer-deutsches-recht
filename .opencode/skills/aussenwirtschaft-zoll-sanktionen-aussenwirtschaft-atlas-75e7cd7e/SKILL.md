---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-atlas-75e7cd7e
description: "Vertiefter Skill fuer Atlas Ausfuhranmeldung Check. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-atlas-ausfuhranmeldung-check/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-atlas-ausfuhranmeldung-check`.

# Atlas Ausfuhranmeldung Check

## Zweck

Dieser Skill behandelt **Atlas Ausfuhranmeldung Check** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
