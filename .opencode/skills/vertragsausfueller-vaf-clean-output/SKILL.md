---
name: vertragsausfueller-vaf-clean-output
...
> Opencode-Port von `vertragsausfueller/skills/vaf-clean-output/SKILL.md`. Urspruenglicher Skill-Name: `vaf-clean-output`.
