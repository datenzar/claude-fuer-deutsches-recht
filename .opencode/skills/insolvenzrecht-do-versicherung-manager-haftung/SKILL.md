---
name: insolvenzrecht-do-versicherung-manager-haftung
...
> Opencode-Port von `insolvenzrecht/skills/do-versicherung-manager-haftung/SKILL.md`. Urspruenglicher Skill-Name: `do-versicherung-manager-haftung`.
