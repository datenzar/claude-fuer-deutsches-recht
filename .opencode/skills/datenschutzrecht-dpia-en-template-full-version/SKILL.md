---
name: datenschutzrecht-dpia-en-template-full-version
...
> Opencode-Port von `datenschutzrecht/skills/dpia-en-template-full-version/SKILL.md`. Urspruenglicher Skill-Name: `dpia-en-template-full-version`.
