---
name: agb-recht-pruefer-crowdfunding-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/crowdfunding-agb/SKILL.md`. Urspruenglicher Skill-Name: `crowdfunding-agb`.

# Crowdfunding AGB

## Wann verwenden

Nutze diesen Skill für **Crowdfunding AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
