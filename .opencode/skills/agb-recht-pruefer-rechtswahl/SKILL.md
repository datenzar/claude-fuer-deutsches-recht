---
name: agb-recht-pruefer-rechtswahl
...
> Opencode-Port von `agb-recht-pruefer/skills/rechtswahl/SKILL.md`. Urspruenglicher Skill-Name: `rechtswahl`.

# Rechtswahl

## Wann verwenden

Nutze diesen Skill für **Rechtswahl** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
