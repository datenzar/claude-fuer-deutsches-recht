---
name: tabellenreview-3d-caching-und-teil-rerun
...
> Opencode-Port von `tabellenreview-3d/skills/caching-und-teil-rerun/SKILL.md`. Urspruenglicher Skill-Name: `caching-und-teil-rerun`.
