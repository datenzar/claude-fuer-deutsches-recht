---
name: regulatorisches-recht-luecken-aufzeiger
...
> Opencode-Port von `regulatorisches-recht/skills/luecken-aufzeiger/SKILL.md`. Urspruenglicher Skill-Name: `luecken-aufzeiger`.
...
Gap-Liste in `./regulatorisches-recht/gap-tracker.yaml` aktualisieren.
