---
name: jurastudium-examens-prognose
...
> Opencode-Port von `jurastudium/skills/examens-prognose/SKILL.md`. Urspruenglicher Skill-Name: `examens-prognose`.
...
1. Lernprofil (`.opencode/profile/jurastudium.md`) → Bundesland/JPA, Prüfungsziel, hochgeladene Klausuren
