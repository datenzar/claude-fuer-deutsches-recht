---
name: agb-recht-pruefer-forschung-entwicklung-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/forschung-entwicklung-agb/SKILL.md`. Urspruenglicher Skill-Name: `forschung-entwicklung-agb`.

# Forschung Entwicklung AGB

## Wann verwenden

Nutze diesen Skill für **Forschung Entwicklung AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
