---
name: agb-recht-pruefer-redline-kommentar-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/redline-kommentar-agb/SKILL.md`. Urspruenglicher Skill-Name: `redline-kommentar-agb`.

# Redline Kommentar AGB

## Wann verwenden

Nutze diesen Skill für **Redline Kommentar AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
