---
name: bank-rechtsabteilung-psd2-open-banking-api-xs2a
...
> Opencode-Port von `bank-rechtsabteilung/skills/psd2-open-banking-api-xs2a/SKILL.md`. Urspruenglicher Skill-Name: `psd2-open-banking-api-xs2a`.
