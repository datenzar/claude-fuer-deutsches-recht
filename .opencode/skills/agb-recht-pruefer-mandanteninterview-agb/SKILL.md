---
name: agb-recht-pruefer-mandanteninterview-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/mandanteninterview-agb/SKILL.md`. Urspruenglicher Skill-Name: `mandanteninterview-agb`.

# Mandanteninterview AGB

## Wann verwenden

Nutze diesen Skill für **Mandanteninterview AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
