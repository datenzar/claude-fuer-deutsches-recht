---
name: produktrecht-workflow-output-waehlen
...
> Opencode-Port von `produktrecht/skills/workflow-output-waehlen/SKILL.md`. Urspruenglicher Skill-Name: `workflow-output-waehlen`.
