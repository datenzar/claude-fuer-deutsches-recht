---
name: agb-recht-pruefer-indexierung
...
> Opencode-Port von `agb-recht-pruefer/skills/indexierung/SKILL.md`. Urspruenglicher Skill-Name: `indexierung`.

# Indexierung

## Wann verwenden

Nutze diesen Skill für **Indexierung** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
