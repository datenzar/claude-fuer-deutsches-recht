---
name: vertragsrecht-vr-leistungsstoerungen-spezial
...
> Opencode-Port von `vertragsrecht/skills/vr-leistungsstoerungen-spezial/SKILL.md`. Urspruenglicher Skill-Name: `vr-leistungsstoerungen-spezial`.

# Vertragsrecht: Leistungsstoerungen

## Aufgabe
Spezialfall Leistungsstoerungen: Unmoeglichkeit § 275 BGB, Verzug § 286 BGB, Schlechtleistung mit Nacherfuellung § 439 / § 635 BGB.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `vertragsrecht` zum Thema `vr-leistungsstoerungen-spezial`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Spezialfall Leistungsstoerungen: Unmoeglichkeit § 275 BGB, Verzug § 286 BGB, Schlechtleistung mit Nacherfuellung § 439 / § 635 BGB. Rechtsfolgen Schadensersatz, Ruecktritt, Minderung. Pruefraster..
