---
name: liquiditaetsplanung-workflow-dokumentenintake
...
> Opencode-Port von `liquiditaetsplanung/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
