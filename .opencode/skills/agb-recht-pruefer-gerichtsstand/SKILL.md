---
name: agb-recht-pruefer-gerichtsstand
...
> Opencode-Port von `agb-recht-pruefer/skills/gerichtsstand/SKILL.md`. Urspruenglicher Skill-Name: `gerichtsstand`.

# Gerichtsstand

## Wann verwenden

Nutze diesen Skill für **Gerichtsstand** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
