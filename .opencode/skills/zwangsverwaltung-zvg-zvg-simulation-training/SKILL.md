---
name: zwangsverwaltung-zvg-zvg-simulation-training
...
> Opencode-Port von `zwangsverwaltung-zvg/skills/zvg-simulation-training/SKILL.md`. Urspruenglicher Skill-Name: `zvg-simulation-training`.
