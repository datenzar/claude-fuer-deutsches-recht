---
name: patentrecht-workflow-dokumentenintake
...
> Opencode-Port von `patentrecht/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
