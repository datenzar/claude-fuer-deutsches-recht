---
name: agb-recht-pruefer-app-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/app-agb/SKILL.md`. Urspruenglicher Skill-Name: `app-agb`.

# App AGB

## Wann verwenden

Nutze diesen Skill für **App AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
