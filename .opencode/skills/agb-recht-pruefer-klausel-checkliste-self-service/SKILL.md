---
name: agb-recht-pruefer-klausel-checkliste-self-service
...
> Opencode-Port von `agb-recht-pruefer/skills/klausel-checkliste-self-service/SKILL.md`. Urspruenglicher Skill-Name: `klausel-checkliste-self-service`.

# Klausel Checkliste Self Service

## Wann verwenden

Nutze diesen Skill für **Klausel Checkliste Self Service** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
