---
name: jveg-kostenpruefer-workflow-dokumentenintake
...
> Opencode-Port von `jveg-kostenpruefer/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
