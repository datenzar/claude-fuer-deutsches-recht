---
name: agb-recht-pruefer-bonitaetspruefung
...
> Opencode-Port von `agb-recht-pruefer/skills/bonitaetspruefung/SKILL.md`. Urspruenglicher Skill-Name: `bonitaetspruefung`.

# Bonitätsprüfung

## Wann verwenden

Nutze diesen Skill für **Bonitätsprüfung** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
