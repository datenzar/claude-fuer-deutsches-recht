---
name: verlagsredaktion-workflow-rechtsquellen-livecheck
...
> Opencode-Port von `verlagsredaktion/skills/workflow-rechtsquellen-livecheck/SKILL.md`. Urspruenglicher Skill-Name: `workflow-rechtsquellen-livecheck`.
