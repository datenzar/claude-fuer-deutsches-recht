---
name: agb-recht-pruefer-datenschutzverweise-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/datenschutzverweise-agb/SKILL.md`. Urspruenglicher Skill-Name: `datenschutzverweise-agb`.

# Datenschutzverweise AGB

## Wann verwenden

Nutze diesen Skill für **Datenschutzverweise AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
