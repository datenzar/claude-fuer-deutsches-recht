---
name: kanzlei-builder-hub-verzeichnis-durchsuchen
...
> Opencode-Port von `kanzlei-builder-hub/skills/verzeichnis-durchsuchen/SKILL.md`. Urspruenglicher Skill-Name: `verzeichnis-durchsuchen`.
...
- Kanzleiprofil: `.opencode/profile/kanzlei-builder-hub.md` → beobachtete Registries
...
3. Zur Watchlist hinzufügen: `.opencode/profile/kanzlei-builder-hub.md` → beobachtete Registries — nur nach Bestätigung
