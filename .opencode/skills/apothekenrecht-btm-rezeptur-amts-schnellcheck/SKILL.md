---
name: apothekenrecht-btm-rezeptur-amts-schnellcheck
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema BtM Rezeptur AMTS Schnellcheck."
---

> Opencode-Port von `apothekenrecht/skills/btm-rezeptur-amts-schnellcheck/SKILL.md`. Urspruenglicher Skill-Name: `btm-rezeptur-amts-schnellcheck`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema BtM Rezeptur AMTS Schnellcheck..
