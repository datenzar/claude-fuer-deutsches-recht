---
name: gesellschaftsrecht-tabellenpruefung
...
> Opencode-Port von `gesellschaftsrecht/skills/tabellenpruefung/SKILL.md`. Urspruenglicher Skill-Name: `tabellenpruefung`.
