---
name: verfassungsrecht-verhaeltnismaessigkeit
...
> Opencode-Port von `verfassungsrecht/skills/verhaeltnismaessigkeit/SKILL.md`. Urspruenglicher Skill-Name: `verhaeltnismaessigkeit`.
