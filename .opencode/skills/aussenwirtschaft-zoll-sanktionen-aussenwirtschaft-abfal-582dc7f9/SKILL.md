---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-abfal-582dc7f9
description: "Vertiefter Skill fuer Abfallverbringung. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-abfallverbringung/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-abfallverbringung`.

# Abfallverbringung

## Zweck

Dieser Skill behandelt **Abfallverbringung** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
