---
name: fachanwalt-migrationsrecht-workflow-asyl-start
...
> Opencode-Port von `fachanwalt-migrationsrecht/skills/workflow-asyl-start/SKILL.md`. Urspruenglicher Skill-Name: `workflow-asyl-start`.
