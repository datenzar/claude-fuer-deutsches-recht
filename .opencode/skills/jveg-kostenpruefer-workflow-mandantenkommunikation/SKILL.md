---
name: jveg-kostenpruefer-workflow-mandantenkommunikation
...
> Opencode-Port von `jveg-kostenpruefer/skills/workflow-mandantenkommunikation/SKILL.md`. Urspruenglicher Skill-Name: `workflow-mandantenkommunikation`.
