---
name: bereicherungs-und-anfechtungsrecht-pruefer-output-klage-fb6e0a8a
...
> Opencode-Port von `bereicherungs-und-anfechtungsrecht-pruefer/skills/output-klageschrift-bereicherungsklage/SKILL.md`. Urspruenglicher Skill-Name: `output-klageschrift-bereicherungsklage`.
