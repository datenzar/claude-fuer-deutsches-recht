---
name: agb-recht-pruefer-vorkasse-abschlag-sicherheit
...
> Opencode-Port von `agb-recht-pruefer/skills/vorkasse-abschlag-sicherheit/SKILL.md`. Urspruenglicher Skill-Name: `vorkasse-abschlag-sicherheit`.

# Vorkasse Abschlag Sicherheit

## Wann verwenden

Nutze diesen Skill für **Vorkasse Abschlag Sicherheit** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
