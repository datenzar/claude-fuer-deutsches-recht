---
name: aussenwirtschaft-zoll-sanktionen-aussenwirtschaft-ma-sa-6533bb8e
description: "Vertiefter Skill fuer Ma Sanctions Export Dd. Fuehrt durch Intake, Rechtsrahmen, Beleglage, Risikoampel, Dokumentation, Freigabe und naechste Schritte im Aussenwirtschafts-, Zoll- und Sanktionsrecht."
---

> Opencode-Port von `aussenwirtschaft-zoll-sanktionen/skills/aussenwirtschaft-ma-sanctions-export-dd/SKILL.md`. Urspruenglicher Skill-Name: `aussenwirtschaft-ma-sanctions-export-dd`.

# Ma Sanctions Export Dd

## Zweck

Dieser Skill behandelt **Ma Sanctions Export Dd** als operativen Workflow fuer Unternehmen, Kanzleien und Rechtsabteilungen. Er ist fuer Faelle gedacht, in denen die erste Antwort nicht nur abstrakt richtig sein muss, sondern als dokumentierte Freigabe, Sperre, Anfrage, Memo oder Behoerdenpaket verwendbar sein soll.
