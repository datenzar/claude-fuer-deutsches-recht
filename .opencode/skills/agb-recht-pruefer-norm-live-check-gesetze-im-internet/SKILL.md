---
name: agb-recht-pruefer-norm-live-check-gesetze-im-internet
...
> Opencode-Port von `agb-recht-pruefer/skills/norm-live-check-gesetze-im-internet/SKILL.md`. Urspruenglicher Skill-Name: `norm-live-check-gesetze-im-internet`.

# Norm Live Check Gesetze Im Internet

## Wann verwenden

Nutze diesen Skill für **Norm Live Check Gesetze Im Internet** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
