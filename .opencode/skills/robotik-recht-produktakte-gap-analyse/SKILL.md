---
name: robotik-recht-produktakte-gap-analyse
...
> Opencode-Port von `robotik-recht/skills/produktakte-gap-analyse/SKILL.md`. Urspruenglicher Skill-Name: `produktakte-gap-analyse`.
