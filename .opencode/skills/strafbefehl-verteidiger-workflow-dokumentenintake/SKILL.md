---
name: strafbefehl-verteidiger-workflow-dokumentenintake
...
> Opencode-Port von `strafbefehl-verteidiger/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
