---
name: agb-recht-pruefer-zahlungsdienste-agb
...
> Opencode-Port von `agb-recht-pruefer/skills/zahlungsdienste-agb/SKILL.md`. Urspruenglicher Skill-Name: `zahlungsdienste-agb`.

# Zahlungsdienste AGB

## Wann verwenden

Nutze diesen Skill für **Zahlungsdienste AGB** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
