---
name: arbeitsrecht-arbeitsrecht-anpassen
...
> Opencode-Port von `arbeitsrecht/skills/arbeitsrecht-anpassen/SKILL.md`. Urspruenglicher Skill-Name: `arbeitsrecht-anpassen`.
...
- Aktuelle Konfigurationsdatei `.opencode/profile/arbeitsrecht.md`

## Ablauf

### 1. Konfiguration lesen

`.opencode/profile/arbeitsrecht.md` und `./unternehmens-profil.md` einlesen.
...
Gespeichert: .opencode/profile/arbeitsrecht.md
```
