---
name: ecommerce-recht-b2c-b2b-plattform-marktplatz-routing
description: "Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema B2C B2B Plattform Marktplatz Routing."
---

> Opencode-Port von `ecommerce-recht/skills/b2c-b2b-plattform-marktplatz-routing/SKILL.md`. Urspruenglicher Skill-Name: `b2c-b2b-plattform-marktplatz-routing`.
...
2. **Normen live prüfen:** Vor tragenden Aussagen den aktuellen Stand aus amtlichen oder frei zugänglichen Quellen kontrollieren. Besonders prüfen: Workflow zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema B2C B2B Plattform Marktplatz Routing..
