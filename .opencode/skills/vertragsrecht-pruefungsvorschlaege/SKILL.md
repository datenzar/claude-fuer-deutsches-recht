---
name: vertragsrecht-pruefungsvorschlaege
...
> Opencode-Port von `vertragsrecht/skills/pruefungsvorschlaege/SKILL.md`. Urspruenglicher Skill-Name: `pruefungsvorschlaege`.
