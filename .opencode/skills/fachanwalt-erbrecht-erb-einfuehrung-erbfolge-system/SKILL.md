---
name: fachanwalt-erbrecht-erb-einfuehrung-erbfolge-system
...
> Opencode-Port von `fachanwalt-erbrecht/skills/erb-einfuehrung-erbfolge-system/SKILL.md`. Urspruenglicher Skill-Name: `erb-einfuehrung-erbfolge-system`.
