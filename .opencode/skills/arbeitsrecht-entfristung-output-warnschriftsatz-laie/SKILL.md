---
name: arbeitsrecht-entfristung-output-warnschriftsatz-laie
...
> Opencode-Port von `arbeitsrecht/skills/entfristung-output-warnschriftsatz-laie/SKILL.md`. Urspruenglicher Skill-Name: `entfristung-output-warnschriftsatz-laie`.
