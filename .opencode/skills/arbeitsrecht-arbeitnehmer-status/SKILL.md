---
name: arbeitsrecht-arbeitnehmer-status
...
> Opencode-Port von `arbeitsrecht/skills/arbeitnehmer-status/SKILL.md`. Urspruenglicher Skill-Name: `arbeitnehmer-status`.
...
- `.opencode/profile/arbeitsrecht.md` → Standort, Klassifizierungsrisiken
