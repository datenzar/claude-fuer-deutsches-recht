---
name: agb-recht-pruefer-sicherungsrechte
...
> Opencode-Port von `agb-recht-pruefer/skills/sicherungsrechte/SKILL.md`. Urspruenglicher Skill-Name: `sicherungsrechte`.

# Sicherungsrechte

## Wann verwenden

Nutze diesen Skill für **Sicherungsrechte** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
