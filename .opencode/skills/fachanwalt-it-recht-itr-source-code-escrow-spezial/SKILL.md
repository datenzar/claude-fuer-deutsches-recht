---
name: fachanwalt-it-recht-itr-source-code-escrow-spezial
...
> Opencode-Port von `fachanwalt-it-recht/skills/itr-source-code-escrow-spezial/SKILL.md`. Urspruenglicher Skill-Name: `itr-source-code-escrow-spezial`.
