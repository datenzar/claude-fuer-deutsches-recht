---
name: robotik-recht-workflow-normen-und-standardrecherche
...
> Opencode-Port von `robotik-recht/skills/workflow-normen-und-standardrecherche/SKILL.md`. Urspruenglicher Skill-Name: `workflow-normen-und-standardrecherche`.
