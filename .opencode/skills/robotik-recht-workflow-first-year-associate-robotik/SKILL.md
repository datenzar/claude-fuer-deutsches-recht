---
name: robotik-recht-workflow-first-year-associate-robotik
...
> Opencode-Port von `robotik-recht/skills/workflow-first-year-associate-robotik/SKILL.md`. Urspruenglicher Skill-Name: `workflow-first-year-associate-robotik`.
