---
name: agb-recht-pruefer-zahlungsmittel-chargeback
...
> Opencode-Port von `agb-recht-pruefer/skills/zahlungsmittel-chargeback/SKILL.md`. Urspruenglicher Skill-Name: `zahlungsmittel-chargeback`.

# Zahlungsmittel Chargeback

## Wann verwenden

Nutze diesen Skill für **Zahlungsmittel Chargeback** im deutschen AGB-Recht, wenn eine Klausel geprüft, entworfen, redlined, verhandelt oder prozessual verteidigt werden soll.
