---
name: kanzlei-builder-hub-workflow-dokumentenintake
...
> Opencode-Port von `kanzlei-builder-hub/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
