---
name: datenschutzrecht-dsfa-template-deutsch-vollvorlage
...
> Opencode-Port von `datenschutzrecht/skills/dsfa-template-deutsch-vollvorlage/SKILL.md`. Urspruenglicher Skill-Name: `dsfa-template-deutsch-vollvorlage`.
