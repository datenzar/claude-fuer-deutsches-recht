---
name: verlagsredaktion-workflow-dokumentenintake
...
> Opencode-Port von `verlagsredaktion/skills/workflow-dokumentenintake/SKILL.md`. Urspruenglicher Skill-Name: `workflow-dokumentenintake`.
