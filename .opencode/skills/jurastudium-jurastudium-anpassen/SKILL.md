---
name: jurastudium-jurastudium-anpassen
...
> Opencode-Port von `jurastudium/skills/jurastudium-anpassen/SKILL.md`. Urspruenglicher Skill-Name: `jurastudium-anpassen`.
...
Dieser Skill ändert einzelne oder mehrere Einträge im Lernprofil unter `.opencode/profile/jurastudium.md`, ohne das gesamte Kaltstart-Interview erneut zu durchlaufen.
...
3. Lernprofil unter `.opencode/profile/jurastudium.md`
...
Gespeichert in: .opencode/profile/jurastudium.md
