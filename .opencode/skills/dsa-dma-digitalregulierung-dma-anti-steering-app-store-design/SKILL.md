---
name: dsa-dma-digitalregulierung-dma-anti-steering-app-store-design
...
> Opencode-Port von `dsa-dma-digitalregulierung/skills/dma-anti-steering-app-store-design/SKILL.md`. Urspruenglicher Skill-Name: `dma-anti-steering-app-store-design`.
