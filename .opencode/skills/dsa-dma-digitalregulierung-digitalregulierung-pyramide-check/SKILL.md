---
name: dsa-dma-digitalregulierung-digitalregulierung-pyramide-check
...
> Opencode-Port von `dsa-dma-digitalregulierung/skills/digitalregulierung-pyramide-check/SKILL.md`. Urspruenglicher Skill-Name: `digitalregulierung-pyramide-check`.
