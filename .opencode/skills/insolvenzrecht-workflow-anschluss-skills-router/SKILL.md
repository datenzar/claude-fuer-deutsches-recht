---
name: insolvenzrecht-workflow-anschluss-skills-router
...
> Opencode-Port von `insolvenzrecht/skills/workflow-anschluss-skills-router/SKILL.md`. Urspruenglicher Skill-Name: `workflow-anschluss-skills-router`.
