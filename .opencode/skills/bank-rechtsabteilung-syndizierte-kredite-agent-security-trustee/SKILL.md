---
name: bank-rechtsabteilung-syndizierte-kredite-agent-security-trustee
...
> Opencode-Port von `bank-rechtsabteilung/skills/syndizierte-kredite-agent-security-trustee/SKILL.md`. Urspruenglicher Skill-Name: `syndizierte-kredite-agent-security-trustee`.
