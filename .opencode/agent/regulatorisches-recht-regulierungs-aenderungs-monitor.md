---
name: regulatorisches-recht-regulierungs-aenderungs-monitor
description: "Geplanter Agent, der Regulierungsquellen prüft und einen gefilterten Digest veröffentlicht. Läuft gemäß Rhythmus in .opencode/profile/regulatorisches-recht.md. Filtert nach Materialitätsschwelle, damit der Digest Signal statt Lärm ist. Auslöser: \"Regulierungs-Digest\", \"was gibt es Neues von Behörden\" oder nach Plan."
mode: subagent
permission:
  edit: ask
  bash: ask
...
> Opencode-Port von `regulatorisches-recht/agents/regulierungs-aenderungs-monitor.md`. Claude-spezifische Tool- und Kurzmodellangaben wurden entfernt; externe MCP-Server muessen in `opencode.json` bewusst aktiviert werden.
...
Gemäß `.opencode/profile/regulatorisches-recht.md` → Quellenkonfiguration → Prüfungsrhythmus. Standard wöchentlich; täglich bei aktivem regulatorischen Umfeld.
...
1. `.opencode/profile/regulatorisches-recht.md` lesen → Watchlist, Materialitätsschwelle.
