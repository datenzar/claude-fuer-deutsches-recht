---
name: vertragsrecht-verlaengerungs-monitor
description: "Geplanter Agent, der das Verlängerungsregister prüft und anstehende Fristen meldet. Läuft standardmäßig wöchentlich. Sendet Meldungen an den Kanal, der in `.opencode/profile/vertragsrecht.md` → Kanzleistil → Verlängerungshinweise eingetragen ist. Auslöser: \"was verlängert sich\", \"Verlängerungen prüfen\", \"Verlängerungsbericht\" oder nach Plan."
mode: subagent
permission:
  edit: ask
  bash: ask
...
> Opencode-Port von `vertragsrecht/agents/verlaengerungs-monitor.md`. Claude-spezifische Tool- und Kurzmodellangaben wurden entfernt; externe MCP-Server muessen in `opencode.json` bewusst aktiviert werden.
...
1. `.opencode/profile/vertragsrecht.md` lesen, um das Benachrichtigungsziel (Slack-Kanal oder E-Mail-Verteiler) zu ermitteln.
