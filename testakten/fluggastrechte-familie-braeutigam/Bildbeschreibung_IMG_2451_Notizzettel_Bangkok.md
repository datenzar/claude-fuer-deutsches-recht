...
INHALT DES ZETTELS (wörtlich abgeschrieben):
  ...
  "PSA Schalter 87 – Mitarbeiter sagte ca. 22:10:
   'technische Probleme am Flugzeug,
   Flug annulliert, keine Voucher verfügbar,
   kommen Sie morgen wieder, wir wissen
   ...
   ca. 30-40 weitere Betroffene am Schalter"

KONTEXT:
- Flug PSA 4472 (BKK → FRA) war für 23:50 Ortszeit geplant
- Annullierung ca. 21:45 Uhr über Lautsprecherdurchsage mitgeteilt
- Sebastian hat den Zettel unmittelbar nach dem Gespräch am Schalter geschrieben
- Zettel dient als Beweis für die Aussagen des PSA-Personals

RELEVANZ FÜR DEN FALL:
Belegt, dass keine Betreuungsleistungen (Voucher, Hotel) angeboten wurden, obwohl dies
nach Art. 9 VO (EG) 261/2004 zwingend vorgeschrieben ist. Außerdem dokumentiert die Aussage
des PSA-Mitarbeiters ("technische Probleme"), was gegen das Vorliegen "außergewöhnlicher
Umstände" im Sinne von Art. 5 Abs. 3 VO 261/2004 spricht (EuGH C-549/07 Wallentin-Hermann).
