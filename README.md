...
|---|---|
| **Plugins** | 167 |
| **Skills (SKILL.md)** | 14160 — [Gesamtübersicht](./SKILLS.md) |
| **Testakten** | 160 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Plugin-Version / Arbeitsstand** | `v69.0.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
