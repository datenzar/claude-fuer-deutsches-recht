...
| [`selbstvertreter-amtsgericht`](./selbstvertreter-amtsgericht) | Plugin für Bürger ohne Anwalt vor dem Amtsgericht: Zuständigkeit, Streitwert, Klageschrift, Erwiderung, Replik, Fristen, Beweise, PKH, Termin und Berufung. Workflow- und Verfahrens-Plugin ohne inhaltliche Prüfung. 82 Skills. |
| [`selbstvertreter-sozialgericht`](./selbstvertreter-sozialgericht) | Plugin für Bürger ohne Anwalt vor dem Sozialgericht: Widerspruch, Klage und Eilantrag bei Pflegegrad, Krankenkasse, Bürgergeld, EM-Rente und GdB. Einfache Sprache, kostenfrei für Versicherte nach § 183 SGG. Workflow-Plugin ohne inhaltliche Rechtsprüfung. 76 Skills. |
